...
- **42_water_demand** Added new parameter (p42_reserved_fraction), global variable (c42_reg_reserved_fraction) and scalar to hold regional value (s42_reg_reserved_fraction).
