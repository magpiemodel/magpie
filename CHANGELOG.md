...
- **21_trade** Revision of trade of timber products. Replaced `s21_trade_bal_damper` in favour of `s21_timber_trade_glo`. A certain share (10% by default) of the global timber demand can be traded globally.
