...
identifier_flag = "DEC49"

cat(paste0("General cleanup and bugfix in forest protetcion according to initial distribution"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
