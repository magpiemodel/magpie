...
for(s73_prod_cost_switch in c(1,0)){
  cfg$gms$s73_prod_cost_switch <- s73_prod_cost_switch
  if(s73_prod_cost_switch == 1) cost_flag = "ProdCostON"
  if(s73_prod_cost_switch == 0) cost_flag = "ProdCostOFF"
