...
identifier_flag = "DEC50"

cat(paste0("Revert bugfix in forest protetcion according to initial distribution"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
