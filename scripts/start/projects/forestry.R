  ...
  for(s35_secdf_distribution in c(2)){
    ...
    for(s32_distribution_type in c(0)){
      for(scen in c("forestry")){
        ...
        for(s35_forest_damage in c(0,1,2)){
          ...
          for(s35_cstock_modifier in c(0)){
            ...
            cfg$gms$s35_cstock_modifier = s35_cstock_modifier
            ...
            if(cfg$gms$s35_cstock_modifier == 0) mod_flag = "NoMod"
            if(cfg$gms$s35_cstock_modifier == 1) mod_flag = "Modified"
      ...
      #      cfg$title   = paste0(identifier_flag,"_",scen_flag,"_",dist_flag,"_",init_flag,"_",damage_flg)
            cfg$title   = paste0(identifier_flag,"_",damage_flg,"_",mod_flag)
