...
identifier_flag = "DEC35"

cat(paste0("primf secdf go through other land. Not changing pcm_carbon_stock in presolve due to inconsisteny with ov_carbon_stock"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
