...
identifier_flag = "DEC45b"

cat(paste0("Estb according to abare data. China starts at 20pc. Overall cap at 66pc"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
