...
identifier_flag = "DEC10"

cat(paste0("min_glo estb requirement increases over time. No upscaling of growth parameters"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
