...
cat(paste0("COP26 deforestation runs - primf to forestry allowed in baseline"), file=paste0(log_folder,"/",identifier_flag,".txt"),append=F)
        ...
        for(ssp in c("SSP2")){
          ...
          for(pol_scen in c("NPI")){
              ...
              for(c21_trade_liberalization in c("l909090r808080")) {
                ...
                if(cfg$gms$c21_trade_liberalization=="l908080r807070")    trade_flag="Liberal"
                if(cfg$gms$c21_trade_liberalization=="regionalized")    trade_flag="Regional"
                if(cfg$gms$c21_trade_liberalization=="globalized")    trade_flag="Global"
                  ...
                  for(c35_protect_scenario in c("WDPA")){
                    ...
                    for(s73_expansion in c(0)){
                      ...
                      for(s10_cop26_deforestation in c(0,1)){
                        ...
                        cfg$title   = paste0(identifier_flag,"_",gsub(pattern="_",replacement="",x=c35_protect_scenario),"_",cop26_flag)
