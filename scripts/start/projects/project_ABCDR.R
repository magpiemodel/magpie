  ...
  for (shr in c(0, 0.005, 0.01, 0.02)) { # share in 2045
    for (growth in c(0,1)) {
      ...
      if (pol == "NDC") {
        ...
        cfg$input['cellular'] <- "rev4.116_36f73207_30c9dc61_cellularmagpie_c400_MRI-ESM2-0-ssp245_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
        ...
        cfg$input['cellular'] <- "rev4.116_36f73207_bc624950_cellularmagpie_c400_MRI-ESM2-0-ssp119_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
