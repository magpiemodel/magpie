...
cfg$input['cellular'] <- "rev4.119_36f73207_bd86374e_cellularmagpie_c200_MRI-ESM2-0-ssp370_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
  ...
  for (shr in c(0, 0.005, 0.01, 0.02)) { # share in 2045
    for (growth in c(0,1)) {
      ...
      if (pol == "NDC") {
        ...
        cfg$input['cellular'] <- "rev4.119_36f73207_582d657c_cellularmagpie_c200_MRI-ESM2-0-ssp245_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
        ...
        cfg$input['cellular'] <- "rev4.119_36f73207_ab632bd4_cellularmagpie_c200_MRI-ESM2-0-ssp119_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
