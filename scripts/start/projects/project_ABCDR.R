...
cfg$input['regional'] <- "rev4.114_36f73207_magpie.tgz"
cfg$input['validation'] <- "rev4.114_36f73207_validation.tgz"
cfg$input['calibration'] <- "calibration_H16_27Sep24.tgz"
cfg$input['cellular'] <- "rev4.114_36f73207_44a213b6_cellularmagpie_c400_MRI-ESM2-0-ssp370_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
  ...
  for (shr in c(0, 0.005, 0.01, 0.02)) { # share in 2045
    for (growth in c(0,1)) {
      ...
      if (pol == "NDC") {
        ...
        cfg$input['cellular'] <- "rev4.114_36f73207_30c9dc61_cellularmagpie_c400_MRI-ESM2-0-ssp245_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
        ...
        cfg$input['cellular'] <- "rev4.114_36f73207_bc624950_cellularmagpie_c400_MRI-ESM2-0-ssp119_lpjml-8e6c5eb1_clusterweight-ba4466a8.tgz"
