...
cfg <- gms::setScenario(cfg,c("SDP","NPI"))
...
cfg <- gms::setScenario(cfg,c("SDP","NDC"))
cfg$gms$c56_pollutant_prices <- "coupling"
cfg$gms$c60_2ndgen_biodem <- "coupling"
...
cfg <- gms::setScenario(cfg,c("SSP1","NDC"))
cfg$gms$c56_pollutant_prices <- "coupling"
cfg$gms$c60_2ndgen_biodem <- "coupling"
...
cfg <- gms::setScenario(cfg,c("SSP5","NPI"))
cfg$gms$c56_pollutant_prices <- "coupling"
cfg$gms$c60_2ndgen_biodem <- "coupling"
...
cfg <- gms::setScenario(cfg,c("SSP5","NDC"))
cfg$gms$c56_pollutant_prices <- "coupling"
cfg$gms$c60_2ndgen_biodem <- "coupling"
