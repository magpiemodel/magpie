...
cfg$title <- "F12_simple_SSP5_timberOn"
cfg$gms$timber <- "biomass_feb20"
#start_run(cfg,codeCheck=FALSE)

cfg <- setScenario(cfg,c("SSP2","NPI"))
cfg$title <- "F12_simple_SSP2_timberOn"
cfg$gms$timber <- "biomass_feb20"
start_run(cfg,codeCheck=FALSE)

cfg <- setScenario(cfg,c("SSP2","NPI"))
cfg$title <- "F12_simple_SSP2_timberOn_freeTrade"
cfg$gms$timber <- "biomass_feb20"
cfg$gms$trade <- "free_apr16"
start_run(cfg,codeCheck=FALSE)

cfg <- setScenario(cfg,c("SSP5","NPI"))
cfg$title <- "F12_simple_SSP5_timberOn_freeTrade"
cfg$gms$timber <- "biomass_feb20"
cfg$gms$trade <- "free_apr16"
start_run(cfg,codeCheck=FALSE)
