...
#   start_run(cfg,codeCheck=FALSE)
  ...
  cfg$title <- paste0("aff_",ssp,"_Budg600_ghgPol_jan20")
  cfg$gms$ghg_policy  <- "price_jan20"
  start_run(cfg,codeCheck=FALSE)

  cfg$title <- paste0("aff_",ssp,"_Budg600_ghgPol_jan20growthrate")
  cfg$gms$ghg_policy  <- "price_jan20_growthrate"
  start_run(cfg,codeCheck=FALSE)

  cfg$title <- paste0("aff_",ssp,"_Budg600_ghgPol_jan19")
  cfg$gms$ghg_policy  <- "price_jan19"
  start_run(cfg,codeCheck=FALSE)
