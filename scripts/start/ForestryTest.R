...
cfg$input <- c("magpie4.0_default_sep18.tgz","additional_data_rev3.65.tgz","isimip_rcp-IPSL_CM5A_LR-rcp2p6-co2_rev35_c200_690d3718e151be1b450b394c1064b1c5.tgz","private_forestry_dec18_20181213v3.tgz")
  ...
  for (rl_estb in rl_establishment){
      ...
      cfg$gms$c32pm_rot_length_estb <- rl_estb
  		if(cfg$gms$c56_pollutant_prices == "SSP2-26-SPA2-V15-REMIND-MAGPIE" ) {
  			...
  			cfg$title<- paste0(t,"_","e",t_estb,"_",format(Sys.time(), format="%Y%m%d"),"_",format(Sys.time(), format="%H%M"))
  			}
