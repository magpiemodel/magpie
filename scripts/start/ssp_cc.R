...
##SSP1
cfg$title <- paste("SSP1_Ref",flag,sep="_")
...
cfg$title <- paste("SSP1_26",flag,sep="_")
...
##SSP3
cfg$title <- paste("SSP3_Ref",flag,sep="_")
cfg <- setScenario(cfg,c("SSP3","NPI"))
cfg$gms$c56_pollutant_prices <- "SSP2-Ref-SPA0-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP2-Ref-SPA0"
start_run(cfg,codeCheck=FALSE)

cfg$title <- paste("SSP3_26",flag,sep="_")
...
##SSP4
cfg$title <- paste("SSP4_Ref",flag,sep="_")
cfg <- setScenario(cfg,c("SSP4","NPI"))
cfg$gms$c56_pollutant_prices <- "SSP2-Ref-SPA0-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP2-Ref-SPA0"
start_run(cfg,codeCheck=FALSE)

cfg$title <- paste("SSP4_26",flag,sep="_")
...
##SSP5
cfg$title <- paste("SSP5_Ref",flag,sep="_")
...
cfg$title <- paste("SSP5_26",flag,sep="_")
cfg <- setScenario(cfg,c("SSP5","NDC"))
cfg$gms$c56_pollutant_prices <- "SSP5-26-SPA2-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP5-26-SPA0"
start_run(cfg,codeCheck=FALSE)
...
cfg$gms$c56_pollutant_prices <- "SSP1-Ref-SPA0-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP1-Ref-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp6p0-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
start_run(cfg,codeCheck=FALSE)
...
cfg$gms$c56_pollutant_prices <- "SSP1-26-SPA1-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP1-26-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp2p6-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
start_run(cfg,codeCheck=FALSE)
...
##SSP4
cfg$title <- paste("SSP4_Ref_RCP60_co2",flag,sep="_")
cfg <- setScenario(cfg,c("SSP4","NPI"))
cfg$gms$c56_pollutant_prices <- "SSP2-Ref-SPA0-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP2-Ref-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp6p0-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
...
cfg$title <- paste("SSP4_26_RCP26_co2",flag,sep="_")
cfg <- setScenario(cfg,c("SSP4","NDC"))
cfg$gms$c56_pollutant_prices <- "SSP2-26-SPA2-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP2-26-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp2p6-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
...
##SSP5
cfg$title <- paste("SSP5_Ref_RCP60_co2",flag,sep="_")
cfg <- setScenario(cfg,c("SSP5","NPI"))
cfg$gms$c56_pollutant_prices <- "SSP5-Ref-SPA0-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP5-Ref-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp6p0-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
...
cfg$title <- paste("SSP5_26_RCP26_co2",flag,sep="_")
cfg <- setScenario(cfg,c("SSP5","NDC"))
cfg$gms$c56_pollutant_prices <- "SSP5-26-SPA2-V15-REMIND-MAGPIE"
cfg$gms$c60_2ndgen_biodem <- "SSP5-26-SPA0"
cfg$input[1] <- "isimip_rcp-IPSL_CM5A_LR-rcp2p6-co2_rev33_c200_690d3718e151be1b450b394c1064b1c5.tgz"
