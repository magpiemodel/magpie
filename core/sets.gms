...
*' Set `i` represents the world regions represented in MAgPIE. The regional
*' specification is not set in stone and can be modified depending on how MAgPIE
...
*' Set `iso` defines the list of countries and the countries are represented by
*' their ISO-3 country code names as part of the ISO 3166 standard published by
...
***TIME STEPS***
*' ATTENTION:
*' Check macros m_year and m_yeardiff if you change something here as they need
*' to make some assumption about these settings, especially having 1965 as start
...
sets
  ...
  y2025, y2030, y2035, y2040, y2045, y2050,
  y2055, y2060, y2065, y2070, y2075, y2080,
  y2085, y2090, y2095, y2100, y2105, y2110,
  y2115, y2120, y2125, y2130, y2135, y2140,
  y2145, y2150
  /
