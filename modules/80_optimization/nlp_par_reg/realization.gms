...
$Ifi "%phase%" == "declarations" $include "./modules/80_optimization/nlp_par_reg/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/80_optimization/nlp_par_reg/input.gms"
$Ifi "%phase%" == "solve" $include "./modules/80_optimization/nlp_par_reg/solve.gms"
