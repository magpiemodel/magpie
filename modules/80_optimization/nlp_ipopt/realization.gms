...
$Ifi "%phase%" == "declarations" $include "./modules/80_optimization/nlp_ipopt/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/80_optimization/nlp_ipopt/input.gms"
$Ifi "%phase%" == "preloop" $include "./modules/80_optimization/nlp_ipopt/preloop.gms"
$Ifi "%phase%" == "solve" $include "./modules/80_optimization/nlp_ipopt/solve.gms"
