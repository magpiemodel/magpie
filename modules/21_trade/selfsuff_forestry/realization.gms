...
$Ifi "%phase%" == "sets" $include "./modules/21_trade/selfsuff_forestry/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/21_trade/selfsuff_forestry/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/21_trade/selfsuff_forestry/input.gms"
