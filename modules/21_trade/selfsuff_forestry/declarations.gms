...
parameters
 ...
 p21_criterion	blub
 p21_prices(t,i,k_trade) blub
 p21_prices_reg(t,i,k_trade) blub
 p21_prices_glo(t,k_trade) blub
 p21_timder_adjustment_ratio(t,i,kforestry) blub
;
...
positive variables
 ...
 v21_cost_supply_missing(i,k_trade)		blub
 v21_cost_export(i,k_trade)		blub
 v21_supply_missing(i,k_trade)					blub
;
...
parameters
 ...
 ov21_cost_supply_missing(t,i,k_trade,type) blub
 ov21_cost_export(t,i,k_trade,type)         blub
 ov21_supply_missing(t,i,k_trade,type)      blub
