...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov21_cost_import(t,i,k_trade,"marginal")    = v21_cost_import.m(i,k_trade);
 ov21_cost_export(t,i,k_trade,"marginal")    = v21_cost_export.m(i,k_trade);
 ov21_trade_bal(t,i,k_trade,"marginal")      = v21_trade_bal.m(i,k_trade);
 ...
 oq21_cost_import(t,i,k_trade,"marginal")    = q21_cost_import.m(i,k_trade);
 oq21_cost_export(t,i,k_trade,"marginal")    = q21_cost_export.m(i,k_trade);
 ...
 ov21_cost_import(t,i,k_trade,"level")       = v21_cost_import.l(i,k_trade);
 ov21_cost_export(t,i,k_trade,"level")       = v21_cost_export.l(i,k_trade);
 ov21_trade_bal(t,i,k_trade,"level")         = v21_trade_bal.l(i,k_trade);
 ...
 oq21_cost_import(t,i,k_trade,"level")       = q21_cost_import.l(i,k_trade);
 oq21_cost_export(t,i,k_trade,"level")       = q21_cost_export.l(i,k_trade);
 ...
 ov21_cost_import(t,i,k_trade,"upper")       = v21_cost_import.up(i,k_trade);
 ov21_cost_export(t,i,k_trade,"upper")       = v21_cost_export.up(i,k_trade);
 ov21_trade_bal(t,i,k_trade,"upper")         = v21_trade_bal.up(i,k_trade);
 ...
 oq21_cost_import(t,i,k_trade,"upper")       = q21_cost_import.up(i,k_trade);
 oq21_cost_export(t,i,k_trade,"upper")       = q21_cost_export.up(i,k_trade);
 ...
 ov21_cost_import(t,i,k_trade,"lower")       = v21_cost_import.lo(i,k_trade);
 ov21_cost_export(t,i,k_trade,"lower")       = v21_cost_export.lo(i,k_trade);
 ov21_trade_bal(t,i,k_trade,"lower")         = v21_trade_bal.lo(i,k_trade);
 ...
 oq21_cost_import(t,i,k_trade,"lower")       = q21_cost_import.lo(i,k_trade);
 oq21_cost_export(t,i,k_trade,"lower")       = q21_cost_export.lo(i,k_trade);
