...
scalars
  ...
  s21_cost_import Cost for additional imports to maintain feasibility (USD17MER per tDM) / 10000 /
  s21_min_trade_margin_forestry Minimum trade margin for forestry products (USD17MER per tDM) / 50 /
;
