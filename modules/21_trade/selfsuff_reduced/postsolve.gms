...
*' Backwards-compatibility: vm_cost_trade is the sum of the three split interfaces.
 vm_cost_trade.l(i) = vm_cost_trade_tariff.l(i) + vm_cost_trade_margin.l(i) + vm_cost_trade_feasibility.l(i);
 ov_cost_trade(t,i,"level") = vm_cost_trade.l(i);
