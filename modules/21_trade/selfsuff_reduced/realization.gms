...
*' The width of the production band is determined by the `i21_trade_bal_reduction` (ptb) factor, which 
*' is allowed to deviate from 1 after the year assigned in sm_fix_SSP2.
*'
