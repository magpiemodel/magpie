...
parameters
 ...
 ov_cost_trade(t,i,type)                       Regional trade costs across all commodities (mio. USD17MER per yr)
 ov_cost_trade_tariff(t,i,type)                Regional tariff costs across all commodities (mio. USD17MER per yr)
 ov_cost_trade_margin(t,i,type)                Regional transport margin costs across all commodities (mio. USD17MER per yr)
 ov_cost_trade_feasibility(t,i,type)           Regional feasibility penalty costs across all commodities (mio. USD17MER per yr)
