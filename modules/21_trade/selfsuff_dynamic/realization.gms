...
$Ifi "%phase%" == "sets" $include "./modules/21_trade/selfsuff_dynamic/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/21_trade/selfsuff_dynamic/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/21_trade/selfsuff_dynamic/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/21_trade/selfsuff_dynamic/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/21_trade/selfsuff_dynamic/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/21_trade/selfsuff_dynamic/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/21_trade/selfsuff_dynamic/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/21_trade/selfsuff_dynamic/postsolve.gms"
