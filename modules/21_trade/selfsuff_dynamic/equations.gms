 ...
 *v21_trade_bal_reduction(k_trade)
 ...
 ((vm_supply(i2,k_trade) + v21_excess_prod(i2,k_trade))/v21_trade_bal_reduction(k_trade))
 $(sum(ct,f21_self_suff(ct,i2,k_trade) >= 1))
 + (vm_supply(i2,k_trade)*sum(ct,f21_self_suff(ct,i2,k_trade))/v21_trade_bal_reduction(k_trade))
 $(sum(ct,f21_self_suff(ct,i2,k_trade) < 1));
