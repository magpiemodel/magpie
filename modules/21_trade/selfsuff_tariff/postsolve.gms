...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov21_export(t,i,k_trade,"marginal")        = v21_export.m(i,k_trade);
 ov21_import(t,i,k_trade,"marginal")        = v21_import.m(i,k_trade);
 oq21_trade_glo(t,k_trade,"marginal")       = q21_trade_glo.m(k_trade);
 oq21_notrade(t,i,k_notrade,"marginal")     = q21_notrade.m(i,k_notrade);
 oq21_trade(t,i,k_trade,"marginal")         = q21_trade.m(i,k_trade);
 ...
 ov21_export(t,i,k_trade,"level")           = v21_export.l(i,k_trade);
 ov21_import(t,i,k_trade,"level")           = v21_import.l(i,k_trade);
 oq21_trade_glo(t,k_trade,"level")          = q21_trade_glo.l(k_trade);
 oq21_notrade(t,i,k_notrade,"level")        = q21_notrade.l(i,k_notrade);
 oq21_trade(t,i,k_trade,"level")            = q21_trade.l(i,k_trade);
 ...
 ov21_export(t,i,k_trade,"upper")           = v21_export.up(i,k_trade);
 ov21_import(t,i,k_trade,"upper")           = v21_import.up(i,k_trade);
 oq21_trade_glo(t,k_trade,"upper")          = q21_trade_glo.up(k_trade);
 oq21_notrade(t,i,k_notrade,"upper")        = q21_notrade.up(i,k_notrade);
 oq21_trade(t,i,k_trade,"upper")            = q21_trade.up(i,k_trade);
 ...
 ov21_export(t,i,k_trade,"lower")           = v21_export.lo(i,k_trade);
 ov21_import(t,i,k_trade,"lower")           = v21_import.lo(i,k_trade);
 oq21_trade_glo(t,k_trade,"lower")          = q21_trade_glo.lo(k_trade);
 oq21_notrade(t,i,k_notrade,"lower")        = q21_notrade.lo(i,k_notrade);
 oq21_trade(t,i,k_trade,"lower")            = q21_trade.lo(i,k_trade);
