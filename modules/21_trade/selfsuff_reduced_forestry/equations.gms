...
q21_cost_trade_ff(i2)..
  vm_cost_trade_forestry_ff(i2)
  =n=
 sum(kforestry,(i21_trade_margin_ff(i2,kforestry) + i21_trade_tariff_ff(i2,kforestry))*(p21_prod_future_reg_ff_level(i2,kforestry)-i21_demand_forestry_future(i2,kforestry)));
*  sum(kforestry,(i21_trade_margin_ff(i2,kforestry) + i21_trade_tariff_ff(i2,kforestry))*(vm_prod_future_reg_ff(i2,kforestry)-i21_demand_forestry_future(i2,kforestry)));
