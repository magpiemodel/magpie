...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov21_cost_tariff_reg(t,h,k_trade,"marginal")    = v21_cost_tariff_reg.m(h,k_trade);
 ov21_cost_transport_reg(t,h,k_trade,"marginal") = v21_cost_transport_reg.m(h,k_trade);
 ov21_trade(t,h_ex,h_im,k_trade,"marginal")      = v21_trade.m(h_ex,h_im,k_trade);
 ...
 oq21_costs_bilateral(t,h,k_trade,"marginal")    = q21_costs_bilateral.m(h,k_trade);
 ...
 ov21_cost_tariff_reg(t,h,k_trade,"level")       = v21_cost_tariff_reg.l(h,k_trade);
 ov21_cost_transport_reg(t,h,k_trade,"level")    = v21_cost_transport_reg.l(h,k_trade);
 ov21_trade(t,h_ex,h_im,k_trade,"level")         = v21_trade.l(h_ex,h_im,k_trade);
 ...
 oq21_costs_bilateral(t,h,k_trade,"level")       = q21_costs_bilateral.l(h,k_trade);
 ...
 ov21_cost_tariff_reg(t,h,k_trade,"upper")       = v21_cost_tariff_reg.up(h,k_trade);
 ov21_cost_transport_reg(t,h,k_trade,"upper")    = v21_cost_transport_reg.up(h,k_trade);
 ov21_trade(t,h_ex,h_im,k_trade,"upper")         = v21_trade.up(h_ex,h_im,k_trade);
 ...
 oq21_costs_bilateral(t,h,k_trade,"upper")       = q21_costs_bilateral.up(h,k_trade);
 ...
 ov21_cost_tariff_reg(t,h,k_trade,"lower")       = v21_cost_tariff_reg.lo(h,k_trade);
 ov21_cost_transport_reg(t,h,k_trade,"lower")    = v21_cost_transport_reg.lo(h,k_trade);
 ov21_trade(t,h_ex,h_im,k_trade,"lower")         = v21_trade.lo(h_ex,h_im,k_trade);
 ...
 oq21_costs_bilateral(t,h,k_trade,"lower")       = q21_costs_bilateral.lo(h,k_trade);
