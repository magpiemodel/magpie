...
equations
 ...
 q21_trade_reg_ff_up(i,kforestry)       Regional trade balances i.e. maximum self-sufficiency ratio (1)
...
parameters
 ...
 oq21_trade_reg_ff_up(t,i,kforestry,type)   Regional trade balances i.e. maximum self-sufficiency ratio (1)
