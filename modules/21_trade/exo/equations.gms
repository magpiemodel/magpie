...
q21_notrade(i2,kall)..
	vm_prod_reg(i2,kall) =g= vm_supply(i2,kall)
 + sum(ct,f21_trade_balance(ct,i2,kall)) - v21_manna_from_heaven(i2,kall);
...
q21_cost_trade(i2).. vm_cost_trade(i2) =e=
                   10**6 * sum(kall,v21_manna_from_heaven(i2,kall));
