...
parameters
 ...
 i21_trade_bilat_flexBand(t_all,i_ex,i_im,k_trade)         Historical flexibility band (rolling range of import supply ratios) opened over time (1)
 i21_trade_bilat_flexBand_capped(t_all,i_ex,i_im,k_trade)  Applied flexibility window = min(lib factor times flexBand and 1) used in the trade bounds (1)
