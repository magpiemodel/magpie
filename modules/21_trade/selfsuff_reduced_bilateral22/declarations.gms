...
parameters
 ...
 i21_trade_bilat_flexBand(t_all,i_ex,i_im,k_trade)         Flexibility band around historical import supply ratios (1)
 i21_trade_bilat_flexBand_capped(t_all,i_ex,i_im,k_trade)  Applied flexibility window is trade liberalization factor times flexBand capped at one (1)
 ...
 p21_import_supply_sum(i_im,t_all,k_trade)                 Sum of import supply ratios across all exporters after scenario scaling (1)
;
