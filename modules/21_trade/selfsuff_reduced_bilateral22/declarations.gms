...
parameters
 ...
 i21_trade_bilat_flexBand_capped(t_all,i_ex,i_im,k_trade)  Applied flexibility window on trade (trade liberalization factor times flexBand, capped at one) (1)
