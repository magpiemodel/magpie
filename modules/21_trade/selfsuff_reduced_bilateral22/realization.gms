...
*' while self-sufficiencies greater than one indicate that the region produces for export. This realization utilizes 
*' bilateral trade costs, inlucding trade margins and tariffs.
*'
