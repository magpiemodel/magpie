...
* Population
  ...
  i09_pop_iso(t_all,iso,pop_gdp_scen09)        Population (mio. per yr)
  i09_pop(t_all,i,pop_gdp_scen09)              Population (mio. per yr)

* GDP in MER
  i09_gdp_mer_iso(t_all,iso,pop_gdp_scen09)    Income in market exchange rates (mio. USD05MER per yr)
  i09_gdp_mer(t_all,i,pop_gdp_scen09)          Income in market exchange rates (mio. USD05MER per yr)

  i09_gdp_pc_mer(t_all,i,pop_gdp_scen09)       Per capita income in market exchange rates (USD05MER per cap per yr)
...
* GDP in PPP
  i09_gdp_ppp_iso(t_all,iso,pop_gdp_scen09)    Income in purchasing power parity (mio. USD05PPP per yr)
  i09_gdp_ppp(t_all,i,pop_gdp_scen09)          Income in purchasing power parity (mio. USD05PPP per yr)

  i09_gdp_pc_ppp(t_all,i,pop_gdp_scen09)       Per capita income in purchasing power parity (USD05PPP per cap per yr)
  i09_gdp_pc_ppp_iso(t_all,iso,pop_gdp_scen09) Per capita income in purchasing power parity (USD05PPP per cap per yr)
