...
* GDP in MER
  ...
  im_gdp_pc_mer(t,i)              	Per capita income in market exchange rates (USD05MER per yr)
  i09_gdp_pc_mer_iso(t,iso)         Per capita income in market exchange rates (USD05MER per yr)
...
* GDP in PPP
  ...
  im_gdp_pc_ppp(t,i)              	Per capita income in purchasing power parity (USD05PPP per yr)
  im_gdp_pc_ppp_iso(t,iso)          Per capita income  (USD05PPP per yr)

* Development State
  im_development_state(t,i)  			Development state according to the World Bank definition (0=low income country, 1=high income country in high income level)  (1)
