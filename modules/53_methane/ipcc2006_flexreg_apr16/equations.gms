...
*' different animals under confinement. Then, we calculate the CH4 emission per
*' MAgPIE livestock products based on @ipcc_2006_2006 and Manure Management Emissions from @FAOSTAT .
