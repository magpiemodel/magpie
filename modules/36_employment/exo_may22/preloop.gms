...
*' In case of a scenario with an external minimum wage we add a linear term to the original 
*' labor costs, which starts from 0 in 2020, reaches the difference the minimum wage and
*' original hourly labor costs in 2050, and then decreases back to 0 in 2100. 
...
*' If productivity increase is assumed to be proportional to hourly labor costs also with external minimum wage,
*' total labor costs should not be scaled. Otherwise, the scaling factor between old and new hourly labor costs will
