...
parameters
 p36_hourly_costs_iso(t_all,iso, wage_scen) Hourly labor costs in agriculture on iso level before and after including wage scenario (USD17MER per hour)
 p36_hourly_costs_increase(iso)         Difference between minimum hourly labor costs and actual hourly labor costs in 2050 (USD17MER per hour)
 pm_hourly_costs(t,i, wage_scen)        Hourly labor costs in agriculture on regional level before and after including wage scenario (USD17MER per hour)
