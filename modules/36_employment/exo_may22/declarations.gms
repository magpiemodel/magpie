...
parameters
 ...
 p36_hourly_costs_iso_min_wage(t,iso)   Hourly labor costs in agriculture on iso level after including minimum wage (USDMER05 per hour)
 p36_hourly_costs(t,i)                  Hourly labor costs in agriculture on regional level (USDMER05 per hour)
 p36_hourly_costs_min_wage(t,i)         Hourly labor costs in agriculture on regional level after including minimum wage (USDMER05 per hour)
