...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/price_jan19/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/price_jan19/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/price_jan19/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/56_ghg_policy/price_jan19/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/56_ghg_policy/price_jan19/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/56_ghg_policy/price_jan19/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/56_ghg_policy/price_jan19/postsolve.gms"
