...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/MMEmu_feb23/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/MMEmu_feb23/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/MMEmu_feb23/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/56_ghg_policy/MMEmu_feb23/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/56_ghg_policy/MMEmu_feb23/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/56_ghg_policy/MMEmu_feb23/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/56_ghg_policy/MMEmu_feb23/postsolve.gms"
