...
scalars
  ...
  c56_ghgprice_linexp Switch between linear (0) and exponential (1) GHG price trajectory / 1 /
  s56_ghgprice_startprice CO2 price at start of phase-in (USD05MER per tCO2) / 0 /
  s56_ghgprice_endprice CO2 price at end of phase-in (USD05MER per tCO2) / 0 / 
