...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/price_jan20_growthrate/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/price_jan20_growthrate/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/price_jan20_growthrate/input.gms"
