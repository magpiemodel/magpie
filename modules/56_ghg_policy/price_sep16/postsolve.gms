...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ov56_reward_cdr_aff(t,j,emis_source_co2_forestry,"marginal")          = v56_reward_cdr_aff.m(j,emis_source_co2_forestry);
 ...
 oq56_emission_costs_reg_yearly(t,i,emis_reg_yearly56,"marginal")      = q56_emission_costs_reg_yearly.m(i,emis_reg_yearly56);
 oq56_emission_costs_reg_oneoff(t,i,emis_reg_oneoff56,"marginal")      = q56_emission_costs_reg_oneoff.m(i,emis_reg_oneoff56);
 ...
 oq56_reward_cdr_aff(t,j,emis_source_co2_forestry,"marginal")          = q56_reward_cdr_aff.m(j,emis_source_co2_forestry);
 ov56_reward_cdr_aff(t,j,emis_source_co2_forestry,"level")             = v56_reward_cdr_aff.l(j,emis_source_co2_forestry);
 ...
 oq56_emission_costs_reg_yearly(t,i,emis_reg_yearly56,"level")         = q56_emission_costs_reg_yearly.l(i,emis_reg_yearly56);
 oq56_emission_costs_reg_oneoff(t,i,emis_reg_oneoff56,"level")         = q56_emission_costs_reg_oneoff.l(i,emis_reg_oneoff56);
 ...
 oq56_reward_cdr_aff(t,j,emis_source_co2_forestry,"level")             = q56_reward_cdr_aff.l(j,emis_source_co2_forestry);
 ov56_reward_cdr_aff(t,j,emis_source_co2_forestry,"upper")             = v56_reward_cdr_aff.up(j,emis_source_co2_forestry);
 ...
 oq56_emission_costs_reg_yearly(t,i,emis_reg_yearly56,"upper")         = q56_emission_costs_reg_yearly.up(i,emis_reg_yearly56);
 oq56_emission_costs_reg_oneoff(t,i,emis_reg_oneoff56,"upper")         = q56_emission_costs_reg_oneoff.up(i,emis_reg_oneoff56);
 ...
 oq56_reward_cdr_aff(t,j,emis_source_co2_forestry,"upper")             = q56_reward_cdr_aff.up(j,emis_source_co2_forestry);
 ov56_reward_cdr_aff(t,j,emis_source_co2_forestry,"lower")             = v56_reward_cdr_aff.lo(j,emis_source_co2_forestry);
 ...
 oq56_emission_costs_reg_yearly(t,i,emis_reg_yearly56,"lower")         = q56_emission_costs_reg_yearly.lo(i,emis_reg_yearly56);
 oq56_emission_costs_reg_oneoff(t,i,emis_reg_oneoff56,"lower")         = q56_emission_costs_reg_oneoff.lo(i,emis_reg_oneoff56);
 ...
 oq56_reward_cdr_aff(t,j,emis_source_co2_forestry,"lower")             = q56_reward_cdr_aff.lo(j,emis_source_co2_forestry);
