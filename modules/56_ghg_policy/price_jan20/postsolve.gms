...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov56_btm_cell(t,j,emis_source,pollutants,"marginal")                  = v56_btm_cell.m(j,emis_source,pollutants);
 ov56_btm_cell_pricing(t,j,emis_source,pollutants,"marginal")          = v56_btm_cell_pricing.m(j,emis_source,pollutants);
 ...
 oq56_technical_mitigation_cell(t,i,pollutants,emis_source,"marginal") = q56_technical_mitigation_cell.m(i,pollutants,emis_source);
 ...
 oq56_co2c_emis(t,j,emis_co2,"marginal")                               = q56_co2c_emis.m(j,emis_co2);
 oq56_co2c_emis_pricing(t,j,emis_co2,"marginal")                       = q56_co2c_emis_pricing.m(j,emis_co2);
 oq56_co2c_emis_pricing2(t,j,pollutants,emis_source,"marginal")        = q56_co2c_emis_pricing2.m(j,pollutants,emis_source);
 ...
 ov56_btm_cell(t,j,emis_source,pollutants,"level")                     = v56_btm_cell.l(j,emis_source,pollutants);
 ov56_btm_cell_pricing(t,j,emis_source,pollutants,"level")             = v56_btm_cell_pricing.l(j,emis_source,pollutants);
 ...
 oq56_technical_mitigation_cell(t,i,pollutants,emis_source,"level")    = q56_technical_mitigation_cell.l(i,pollutants,emis_source);
 ...
 oq56_co2c_emis(t,j,emis_co2,"level")                                  = q56_co2c_emis.l(j,emis_co2);
 oq56_co2c_emis_pricing(t,j,emis_co2,"level")                          = q56_co2c_emis_pricing.l(j,emis_co2);
 oq56_co2c_emis_pricing2(t,j,pollutants,emis_source,"level")           = q56_co2c_emis_pricing2.l(j,pollutants,emis_source);
 ...
 ov56_btm_cell(t,j,emis_source,pollutants,"upper")                     = v56_btm_cell.up(j,emis_source,pollutants);
 ov56_btm_cell_pricing(t,j,emis_source,pollutants,"upper")             = v56_btm_cell_pricing.up(j,emis_source,pollutants);
 ...
 oq56_technical_mitigation_cell(t,i,pollutants,emis_source,"upper")    = q56_technical_mitigation_cell.up(i,pollutants,emis_source);
 ...
 oq56_co2c_emis(t,j,emis_co2,"upper")                                  = q56_co2c_emis.up(j,emis_co2);
 oq56_co2c_emis_pricing(t,j,emis_co2,"upper")                          = q56_co2c_emis_pricing.up(j,emis_co2);
 oq56_co2c_emis_pricing2(t,j,pollutants,emis_source,"upper")           = q56_co2c_emis_pricing2.up(j,pollutants,emis_source);
 ...
 ov56_btm_cell(t,j,emis_source,pollutants,"lower")                     = v56_btm_cell.lo(j,emis_source,pollutants);
 ov56_btm_cell_pricing(t,j,emis_source,pollutants,"lower")             = v56_btm_cell_pricing.lo(j,emis_source,pollutants);
 ...
 oq56_technical_mitigation_cell(t,i,pollutants,emis_source,"lower")    = q56_technical_mitigation_cell.lo(i,pollutants,emis_source);
 ...
 oq56_co2c_emis(t,j,emis_co2,"lower")                                  = q56_co2c_emis.lo(j,emis_co2);
 oq56_co2c_emis_pricing(t,j,emis_co2,"lower")                          = q56_co2c_emis_pricing.lo(j,emis_co2);
 oq56_co2c_emis_pricing2(t,j,pollutants,emis_source,"lower")           = q56_co2c_emis_pricing2.lo(j,pollutants,emis_source);
