...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 oq56_emis_co2_actual(t,i,emis_oneoff,"marginal")                 = q56_emis_co2_actual.m(i,emis_oneoff);
 oq56_technical_mitigation(t,i,pollutants,emis_source,"marginal") = q56_technical_mitigation.m(i,pollutants,emis_source);
 ...
 oq56_emis_co2_actual(t,i,emis_oneoff,"level")                    = q56_emis_co2_actual.l(i,emis_oneoff);
 oq56_technical_mitigation(t,i,pollutants,emis_source,"level")    = q56_technical_mitigation.l(i,pollutants,emis_source);
 ...
 oq56_emis_co2_actual(t,i,emis_oneoff,"upper")                    = q56_emis_co2_actual.up(i,emis_oneoff);
 oq56_technical_mitigation(t,i,pollutants,emis_source,"upper")    = q56_technical_mitigation.up(i,pollutants,emis_source);
 ...
 oq56_emis_co2_actual(t,i,emis_oneoff,"lower")                    = q56_emis_co2_actual.lo(i,emis_oneoff);
 oq56_technical_mitigation(t,i,pollutants,emis_source,"lower")    = q56_technical_mitigation.lo(i,pollutants,emis_source);
