...
equations
 q56_technical_mitigation_reg(i,pollutants,emis_source_reg)   Application of maccs on emissions (Tg per yr)
 q56_technical_mitigation_cell(i,pollutants,emis_source_cell)  Application of maccs on emissions (Tg per yr)
 ...
 q56_emis_co2(j,emis_co2)             		 			  Calculation of annual CO2 emissions (Tg per yr)
 q56_pricing_emis_co2(j,emis_co2)						  Calculation of annual CO2 emissions for pricing (Tg per yr)
 q56_pricing_emis_cell_yr(j,pollutants,emis_cell_yr56)	  Calculation of GHG emissions for pricing (Tg per yr)
 q56_pricing_emis_cell_one(j,pollutants,emis_cell_one56)  Calculation of GHG emissions for pricing (Tg per yr)
;
...
variables
 vm_btm_reg(i,emis_source_reg,pollutants)                    Regional emissions before technical mitigation (Tg per yr)
 vm_btm_cell(j,emis_source_cell,pollutants)                  Cellular emissions before technical mitigation (Tg per yr)
 v56_btm_cell_pricing(j,emis_source_cell,pollutants)         Cellular emissions before technical mitigation (Tg per yr)
...
parameters
 ...
 ov_btm_reg(t,i,emis_source_reg,pollutants,type)                      Regional emissions before technical mitigation (Tg per yr)
 ov_btm_cell(t,j,emis_source_cell,pollutants,type)                    Cellular emissions before technical mitigation (Tg per yr)
 ov56_btm_cell_pricing(t,j,emis_source_cell,pollutants,type)          Cellular emissions before technical mitigation (Tg per yr)
 ...
 oq56_technical_mitigation_reg(t,i,pollutants,emis_source_reg,type)   Application of maccs on emissions (Tg per yr)
 oq56_technical_mitigation_cell(t,i,pollutants,emis_source_cell,type) Application of maccs on emissions (Tg per yr)
 ...
 oq56_emis_co2(t,j,emis_co2,type)                                     Calculation of annual CO2 emissions (Tg per yr)
 oq56_pricing_emis_co2(t,j,emis_co2,type)                             Calculation of annual CO2 emissions for pricing (Tg per yr)
 oq56_pricing_emis_cell_yr(t,j,pollutants,emis_cell_yr56,type)        Calculation of GHG emissions for pricing (Tg per yr)
 oq56_pricing_emis_cell_one(t,j,pollutants,emis_cell_one56,type)      Calculation of GHG emissions for pricing (Tg per yr)
;
