...
$Ifi "%phase%" == "sets" $include "./modules/56_ghg_policy/price_jan20_woa/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/56_ghg_policy/price_jan20_woa/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/56_ghg_policy/price_jan20_woa/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/56_ghg_policy/price_jan20_woa/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/56_ghg_policy/price_jan20_woa/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/56_ghg_policy/price_jan20_woa/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/56_ghg_policy/price_jan20_woa/postsolve.gms"
