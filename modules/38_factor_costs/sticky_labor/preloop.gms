...
p38_cost_share(t,i,"capital")$(m_year(t)<2010) = f38_historical_share(t,i);
p38_cost_share(t,i,"capital")$(m_year(t)>=2010) = f38_reg_parameters("slope")*log10(sum(i_to_iso(i,iso),im_gdp_pc_ppp_iso(t,iso)))+f38_reg_parameters("intercept")+p38_share_calibration(i);
