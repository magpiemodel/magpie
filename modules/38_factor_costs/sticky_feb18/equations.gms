...
* The factor costs split in tow parts:
* a) variable costs such as labour inputs

q38_cost_prod_crop(i2,kcr) .. vm_cost_prod(i2,kcr) =e= vm_prod_reg(i2,kcr) * i38_variable_costs(i2,kcr) / (1-v38_mi(i2))
                              + v38_investment_annuity(i2,kcr)+ p38_past_annuity(i2,kcr);

* b) investment costs for capital stocks.

* Each cropping activity requires a certain capital stock that depends on the
* management intensity vm_tau. These investments are assumed to be sunk costs.
