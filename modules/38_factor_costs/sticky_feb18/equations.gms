...
q38_cost_prod_inv(i2).. vm_cost_inv(i2)=e=v38_investment_annuity(i2)
                                ;
*/ (1-v38_mi(i2))
...
q38_investment_annuity(i2) ..
                          v38_investment_annuity(i2)
                          =e=
                          (sum((cell(i2,j2),kcr),
                          v38_investment_immobile(j2,kcr))+sum((cell(i2,j2)),
