...
i38_capital_need(i,kcr,"mobile") = f38_fac_req_per_ton(kcr) * s38_capital_cost_share * (1-s38_immobile);
i38_capital_need(i,kcr,"immobile") = f38_fac_req_per_ton(kcr)*s38_capital_cost_share * s38_immobile;
i38_capital_need(i,perennials38,"mobile") = f38_fac_req_per_ton(perennials38)* s38_capital_cost_share * (1-s38_immobile_perennials);
i38_capital_need(i,perennials38,"immobile") = f38_fac_req_per_ton(perennials38)* s38_capital_cost_share * s38_immobile_perennials;
...
i38_annuity_factor =((1-s38_depreciation_rate)*(pm_interest(i2)/((1+pm_interest(i2))))
