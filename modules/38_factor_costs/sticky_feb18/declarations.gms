...
parameters
 p38_variable_costs(t,i,kcr)           Variable input costs (mio USD05MER per input unit)
 p38_capital_need(t,i,kcr,mobil38)     Capital requirements for farming with tau equal 1 (mio USD05MER)
