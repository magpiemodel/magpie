...
*' @equations
 ...
 q38_cost_prod_crop(i2,req) ..
  vm_cost_prod_crop(i2,req) =e= sum(kcr, vm_prod_reg(i2,kcr) * i38_fac_req(i2,kcr))* sum(ct,p38_cost_share(ct,i2,req));
...
*' factor requirements per volume of production `i38_fac_req`.
