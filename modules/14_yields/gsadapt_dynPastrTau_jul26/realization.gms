...
*' ### TODO: Fix module and realization text before production use
*'
*' @description The gsadapt_dynPastrTau_jul26 realization reads in the LPJmL data
*' and accounts for growing period adaption to climate change. It also
...
*'
*' The realization supports two pasture spillover modes controlled by s14_past_spillover_mode:
*'   * Mode 0 (static scalar): Uses s14_yld_past_switch for all regions and timesteps
*'   * Mode 1 (regional dynamic): Uses f14_yld_past_switch(t_all,i) per region and timestep
*' Both modes integrate growing period adaptation support (gsadapt/constgsadapt) via s14_use_gsadapt.
