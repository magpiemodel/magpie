...
parameters
 ...
 i14_croparea_total(t_past,w,j)                           Cellular croparea (mio. ha)
 ...
 i14_yields_hist(t,i,kcr)                                Harmonized historical yields per region at the historical reference year (tDM per ha per yr)
 i14_lambda_yields(t,i,kcr)                              Scaling factor for non-linear management calibration (1)
 i14_managementcalib(t,j,kcr,w)                          Regional management calibration factor accounting for historical yield levels (1)
 ...
 pm_yields_semi_calib(j,kve,w)                           Potential yields calibrated to historical regional levels (tDM per ha per yr)
