...
*' The following equations calibrate the cellular yield pattern ('f14_yields') to match
*'  FAO historical yields ('f14_regions_yields') by calculating a calibration term called
*' 'i14_managementcalib'. For most cases, 'i14_managementcalib' is the ratio of the historical
*'  yields reported by FAO ('f14_regions_yields') and regional mean yields  ('i14_lpj_yields_hist')
...
*' ('i14_lpj_yields_hist') from the given cellular input pattern. In rare cases where
