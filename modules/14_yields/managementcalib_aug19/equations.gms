...
q14_yield_crop(j2,kcr,w) ..
 vm_yld(j2,kcr,w) =e= sum(ct,i14_yields_calib(ct,j2,kcr,w)) * sum(cell(i2,j2), vm_tau(i2) / fm_tau1995(i2));
 ...
 * (1 + s14_yld_past_switch*(sum(cell(i2,j2),pcm_tau(i2)/fm_tau1995(i2)) - 1));
