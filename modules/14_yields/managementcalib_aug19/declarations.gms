...
parameters
 ...
 p14_calib_yields_ratio(i)                               Irrigated to rainfed yield ratio for calibrated yields (1)
 p14_target_ratio(i)                                     Target irrigated to rainfed ratio as upper bound (1)
