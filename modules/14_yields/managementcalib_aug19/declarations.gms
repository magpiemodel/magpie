...
parameters
 ...
 p14_growing_stock(t,j,ac,land_timber,forest_type)       Forest growing stock (tDM per ha per yr)
 pm_timber_yield(t,j,ac,land_timber)                     Forest growing stock (tDM per ha per yr)
 p14_growing_stock_initial(j,ac,land_timber,forest_type) Initial Forest growing stock (tDM per ha per yr)
 pm_timber_yield_initial(j,ac,land_timber)               Initial Forest yield (tDM per ha per yr)
