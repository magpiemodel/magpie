...
parameters
          ...
          i59_scm_target(t,j)                  Share of land under soil carbon managament (1)
          ...
          i59_scm_ratio(j)                     Ratio of carbon density of land under soil carbon managament relative to natural vegetation (1)
          i59_scm_scenario_fader(t_all)        Cropland soil carbon management scenario fader (1)
          p59_country_switch(iso)              Switch indicating whether country is affected by selected soil carbon management policy (1)
