...
parameters
 ...
 ov59_som_transfer_to_cropland(t,j,noncropland59,type) Transfer of SOM from other land to cropland (mio. tC)
 ...
 oq59_som_transfer_to_cropland(t,j,noncropland59,type) Estimates the transfer of carbon pools due to land conversion (mio. tC)
 oq59_som_pool_cropland(t,j,type)                      Actual C pool in croplands (mio. tC)
 oq59_som_pool_noncropland(t,j,noncropland59,type)     Actual C pool in non-croplands (mio. tC)
