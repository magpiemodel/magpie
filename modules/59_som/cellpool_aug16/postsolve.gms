...
p59_carbon_density(t,j,noncropland59)$(pcm_land(j,noncropland59)>0.000001) = p59_som_pool(j,noncropland59) / pcm_land(j,noncropland59);
p59_carbon_density(t,j,"crop")$(pcm_land(j,"crop")>0.000001) = p59_som_pool(j,"crop") / pcm_land(j,"crop");
