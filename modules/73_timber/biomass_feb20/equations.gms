...
q73_hvarea_forestry(j2,ac_sub) ..
                          ...
                          =e=
                          sum(kforestry, v73_prod_forestry(j2,ac_sub,kforestry)) / sum(ct, pm_growing_stock(ct,j2,ac_sub,"forestry"));
...
q73_prod_secdforest(j2,ac_sub)..
                           ...
                           =l=
						    vm_secdforest_reduction(j2,ac_sub) * sum(ct,pm_growing_stock(ct,j2,ac_sub,"secdforest"));
...
q73_hvarea_secdforest(j2,ac_sub)..
                          vm_hvarea_secdforest(j2,ac_sub)
                           =e=
                          sum(kforestry, v73_prod_natveg(j2,"secdforest",ac_sub,kforestry)) / sum(ct, pm_growing_stock(ct,j2,ac_sub,"secdforest"));
...
q73_prod_primforest(j2)..
                           ...
                           =l=
                           vm_primforest_reduction(j2) * sum(ct, pm_growing_stock(ct,j2,"acx","primforest"));
...
q73_hvarea_primforest(j2)..
                          vm_hvarea_primforest(j2)
                           =e=
                          sum(kforestry, v73_prod_natveg(j2,"primforest","acx",kforestry)) / sum(ct, pm_growing_stock(ct,j2,"acx","primforest"));
...
q73_prod_other(j2,ac_sub)..
                          ...
                          =l=
                          vm_other_reduction(j2,ac_sub) * sum(ct, pm_growing_stock(ct,j2,ac_sub,"other"))
                          ;
