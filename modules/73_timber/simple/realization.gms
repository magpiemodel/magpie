...
*' @description NEEDS UPDATE biomass_mar20 realization acts as a common tunnel for land related
...
$Ifi "%phase%" == "declarations" $include "./modules/73_timber/simple/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/73_timber/simple/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/73_timber/simple/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/73_timber/simple/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/73_timber/simple/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/73_timber/simple/postsolve.gms"
