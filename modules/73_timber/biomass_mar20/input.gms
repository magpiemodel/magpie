...
* https://unece.org/forests/prices
  ...
  s73_timber_harvest_cost_forestry     Cost for harvesting from timber plantations (USD per ha) / -2000/
  s73_timber_harvest_cost_secdforest   Cost for harvesting from secondary forest (USD per ha) / 2000/
  s73_timber_harvest_cost_other        Cost for harvesting from other land (USD per ha) / 2000/
  s73_timber_harvest_cost_primforest   Cost for harvesting from primary forest (USD per ha) / 3000/
