...
q73_prod_forestry(j2,ac_sub)..
                         ...
                         =l=
                         sum(type32, vm_forestry_reduction(j2,type32,ac_sub)) * sum(ct, pm_growing_stock(ct,j2,ac_sub,"forestry","%c73_timber_plantations%"));

q73_hvarea_forestry(j2,ac_sub) ..
                          vm_hvarea_forestry(j2,ac_sub)
                          =e=
                          sum(kforestry, v73_prod_forestry(j2,ac_sub,kforestry)) / sum(ct, pm_growing_stock(ct,j2,ac_sub,"forestry","%c73_timber_plantations%"));
...
q73_prod_secdforest(j2,ac_sub)..
                           ...
                           =l=
						    vm_secdforest_reduction(j2,ac_sub) * sum(ct,pm_growing_stock(ct,j2,ac_sub,"secdforest","%c73_timber_natveg%"));
...
q73_hvarea_secdforest(j2,ac_sub)..
                          vm_hvarea_secdforest(j2,ac_sub)
                           =e=
                          sum(kforestry, v73_prod_natveg(j2,"secdforest",ac_sub,kforestry)) / sum(ct, pm_growing_stock(ct,j2,ac_sub,"secdforest","%c73_timber_natveg%"));
...
q73_prod_primforest(j2)..
                           ...
                           =l=
                           vm_primforest_reduction(j2) * sum(ct, pm_growing_stock(ct,j2,"acx","primforest","%c73_timber_natveg%"));
...
q73_hvarea_primforest(j2)..
                          vm_hvarea_primforest(j2)
                           =e=
                          sum(kforestry, v73_prod_natveg(j2,"primforest","acx",kforestry)) / sum(ct, pm_growing_stock(ct,j2,"acx","primforest","%c73_timber_natveg%"));
...
q73_prod_other(j2,ac_sub)..
                          ...
                          =l=
                          vm_other_reduction(j2,ac_sub) * sum(ct, pm_growing_stock(ct,j2,ac_sub,"other","%c73_timber_natveg%"))
                          ;
...
q73_hvarea_other(j2,ac_sub)..
                         v73_hvarea_other(j2, ac_sub)
                          =e=
                         v73_prod_natveg(j2,"other",ac_sub,"woodfuel") / sum(ct, pm_growing_stock(ct,j2,ac_sub,"other","%c73_timber_natveg%"));
