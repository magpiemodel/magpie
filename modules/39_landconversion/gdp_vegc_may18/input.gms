...
table f39_landclear_gdp(cost_estimate39,bound39) global range of land clearing costs in inital timestep (USD per ton C)
$ondelim
$include "./modules/39_landconversion/gdp_vegc_may18/input/f39_landclear_gdp.cs3"
$offdelim;


table f39_establish_gdp(land,cost_estimate39,bound39) global range of land establishment costs in inital timestep (USD per hectare)
$ondelim
