...
q32_bv_aff(j2,potnatveg) .. vm_bv(j2,"aff_co2p",potnatveg)
 				  =e=
          sum(bii_secd, sum(ac_to_bii_secd(ac,bii_secd), v32_land(j2,"aff",ac)) * 
          p32_bii_coeff("aff",bii_secd,potnatveg)) * fm_luh2_side_layers(j2,potnatveg);

q32_bv_ndc(j2,potnatveg) .. vm_bv(j2,"aff_ndc",potnatveg)
 					=e=
          sum(bii_secd, sum(ac_to_bii_secd(ac,bii_secd), v32_land(j2,"ndc",ac)) * 
          p32_bii_coeff("ndc",bii_secd,potnatveg)) * fm_luh2_side_layers(j2,potnatveg);

q32_bv_plant(j2,potnatveg) .. vm_bv(j2,"plant",potnatveg)
 					=e=
          sum(bii_secd, sum(ac_to_bii_secd(ac,bii_secd), v32_land(j2,"plant",ac)) * 
          p32_bii_coeff("plant",bii_secd,potnatveg)) * fm_luh2_side_layers(j2,potnatveg);
