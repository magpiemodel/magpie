...
q32_bv_aff(j2,potnatveg) .. vm_bv(j2,"aff",potnatveg)
 				  =e=
          v32_land(j2,"aff",ac_mature) * fm_bii_coeff("secd_mature",potnatveg) * fm_luh2_side_layers(j2,potnatveg)
        + v32_land(j2,"aff",ac_young) * fm_bii_coeff("secd_young",potnatveg) * fm_luh2_side_layers(j2,potnatveg);

q32_bv_ndc(j2,potnatveg) .. vm_bv(j2,"ndc",potnatveg)
 					=e=
          v32land(j2,"ndc",ac_mature) * fm_bii_coeff("secd_mature",potnatveg) * fm_luh2_side_layers(j2,potnatveg)
        + v32land(j2,"ndc",ac_young) * fm_bii_coeff("secd_young",potnatveg) * fm_luh2_side_layers(j2,potnatveg);

q32_bv_plant(j2,potnatveg) .. vm_bv(j2,"plant",potnatveg)
 					=e=
          v32_land(j2,"plant",ac) * fm_bii_coeff("timber",potnatveg) * fm_luh2_side_layers(j2,potnatveg);
