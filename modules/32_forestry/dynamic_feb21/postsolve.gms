...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 oq32_carbon1(t,j,ag_pools,"marginal")            = q32_carbon1.m(j,ag_pools);
 oq32_carbon2(t,j,ag_pools,"marginal")            = q32_carbon2.m(j,ag_pools);
 oq32_carbon3(t,j,ag_pools,"marginal")            = q32_carbon3.m(j,ag_pools);
 oq32_carbon4(t,j,ag_pools,"marginal")            = q32_carbon4.m(j,ag_pools);
 ...
 oq32_carbon1(t,j,ag_pools,"level")               = q32_carbon1.l(j,ag_pools);
 oq32_carbon2(t,j,ag_pools,"level")               = q32_carbon2.l(j,ag_pools);
 oq32_carbon3(t,j,ag_pools,"level")               = q32_carbon3.l(j,ag_pools);
 oq32_carbon4(t,j,ag_pools,"level")               = q32_carbon4.l(j,ag_pools);
 ...
 oq32_carbon1(t,j,ag_pools,"upper")               = q32_carbon1.up(j,ag_pools);
 oq32_carbon2(t,j,ag_pools,"upper")               = q32_carbon2.up(j,ag_pools);
 oq32_carbon3(t,j,ag_pools,"upper")               = q32_carbon3.up(j,ag_pools);
 oq32_carbon4(t,j,ag_pools,"upper")               = q32_carbon4.up(j,ag_pools);
 ...
 oq32_carbon1(t,j,ag_pools,"lower")               = q32_carbon1.lo(j,ag_pools);
 oq32_carbon2(t,j,ag_pools,"lower")               = q32_carbon2.lo(j,ag_pools);
 oq32_carbon3(t,j,ag_pools,"lower")               = q32_carbon3.lo(j,ag_pools);
 oq32_carbon4(t,j,ag_pools,"lower")               = q32_carbon4.lo(j,ag_pools);
