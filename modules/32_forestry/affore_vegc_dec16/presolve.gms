...
*' @code Documentation of presolve.gms:
*'
...
*' Exclude certain areas (e.g. the boreal zone) from endogenous afforestation.
v32_land.lo(j,"new") = 0;
v32_land.up(j,"new") = f32_aff_mask(j) * sum(land, pcm_land(j,land));

*' Limit endogenous afforestation to cells with vegetation carbon density above 20 tC/ha.
