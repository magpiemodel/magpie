...
v32_land.l(j,land32,si) = sum(j_ac_land32(j,ac,land32), p32_land_fore(t,j,ac,si,"before"));
...
v32_land.fx(j,"grow",si) = pc32_land_fore(j,"grow",si);
...
p32_carbon_density_cc(t,j,"prot",c_pools) = m_weightedmean(pm_carbon_density_ac(t,j,ac,c_pools),p32_land_fore(t,j,ac,si,"before"),(j_ac_land32(j,ac,"prot"),si));
p32_carbon_density_cc(t,j,"grow",c_pools) = m_weightedmean(pm_carbon_density_ac(t,j,ac,c_pools),p32_land_fore(t,j,ac,si,"before"),(j_ac_land32(j,ac,"grow"),si));
...
p32_carbon_density_nocc(t,j,"prot",c_pools) = m_weightedmean(pm_carbon_density_ac("y1995",j,ac,c_pools),p32_land_fore(t,j,ac,si,"before"),(j_ac_land32(j,ac,"prot"),si));
p32_carbon_density_nocc(t,j,"grow",c_pools) = m_weightedmean(pm_carbon_density_ac("y1995",j,ac,c_pools),p32_land_fore(t,j,ac,si,"before"),(j_ac_land32(j,ac,"grow"),si));
