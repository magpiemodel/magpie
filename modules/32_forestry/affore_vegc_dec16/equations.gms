...
*****forestry emissions seen in maccs module****************************************
 q32_cdr_aff(j2,emis_co2_forestry) .. vm_cdr_aff(j2,emis_co2_forestry) =e=
                                        sum((ac,si,emis_co2_to_forestry(emis_co2_forestry,c_pools))$(ord(ac) > 1 AND (ord(ac)-1) <= sm_invest_horizon/5),
...
*****Land***************************************************
 ...
 q32_max_aff .. sum((j2,si), vm_land(j2,"forestry",si)-pm_land_start_si(j2,"forestry",si)) =l= 
					s32_max_aff_area;
