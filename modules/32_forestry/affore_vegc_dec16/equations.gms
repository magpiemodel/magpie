...
=e=
sum((ac,emis_co2_to_forestry(emis_source_co2_forestry,c_pools))$(ord(ac) > 1
...
*' This is calculated from the forestry land CO2 emissions of the "Newly"
*' planted trees multiplied by the Difference between the age-class and carbon
*' pool dependent carbon density of consecutive age classes.

*****Land***************************************************
 q32_land(j2) .. vm_land(j2,"forestry") =e= sum(land32, v32_land(j2,land32));

*' Forestry component of `vm_land`([10_land]) interface is set equal to the sum
*' of all kinds of existing forestry land over each cell.

 q32_aff_pol(j2) .. v32_land(j2,"new_ndc")
                    =e=
