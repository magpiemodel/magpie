...
equations
 ...
 q32_prod_future(j)                               Establishment in current time step for future demand (mio. ha)
...
parameters
 ...
 oq32_prod_future(t,j,type)                                Establishment in current time step for future demand (mio. ha)
