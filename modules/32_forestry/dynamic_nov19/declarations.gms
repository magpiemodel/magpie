...
parameters
 ...
 p32_rotation_cellular(t_all,j)                         Cellular length translated to age classes on cellular level (1)
 ...
 pm_rot_length_estb(t_all,j)                            Regional rotation length of plantations translated to age class equivalent for future (1)
 p32_rotation_cellular_estb(t_all,j)                    Rotation length translated to age classes on cellular level (1)
 p32_rotation_cellular_harvesting(t_all,j)             Cellular rotation length of plantations translated to age class equivalent for future (1)
 ...
 p32_interest(t_all,i)     Interest rate in each region and timestep (% per yr)
...
positive variables
 ...
 vm_hvarea_forestry(j,kforestry,ac_sub)             Area harvested for timber production (mio. ha)
...
parameters
 ...
 ov_hvarea_forestry(t,j,kforestry,ac_sub,type) Area harvested for timber production (mio. ha)
