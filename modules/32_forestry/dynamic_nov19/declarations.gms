...
parameters
 ...
 p32_rot_length_estb(t_all,j)                           Rotation length for establishment (yr)
 ...
 p32_rotation_cellular_estb_update(t_all,j)             Cellular rotation length of plantations translated to age class equivalent for future (1)
