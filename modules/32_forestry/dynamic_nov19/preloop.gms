...
p32_IGR(t,j,ac_sub) = (p32_carbon_density_ac_marg(t,j,ac_sub)/p32_carbon_density_ac_nat(t,j,ac_sub))$(p32_carbon_density_ac_nat(t,j,ac_sub)>0) + 1$(p32_carbon_density_ac_nat(t,j,ac_sub)>0);
