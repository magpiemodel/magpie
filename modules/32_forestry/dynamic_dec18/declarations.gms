...
equations
 ...
 q32_production_timber		                      Timber production from plantations (mio. USD)
 q32_prod_future	                              Establishment in current time step for future demand (mio. ha)
...
parameters
 ...
 oq32_production_timber(t,type)                  Timber production from plantations (mio. USD)
 oq32_prod_future(t,type)                        Establishment in current time step for future demand (mio. ha)
