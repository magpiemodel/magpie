...
equations
 ...
 q32_production_timber(kforestry)                         Timber production from plantations (mio. USD)
...
parameters
 ...
 oq32_production_timber(t,kforestry,type)        Timber production from plantations (mio. USD)
