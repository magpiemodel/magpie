...
v32_cost_establishment.scale(i) = 10e6;
v32_cost_recur.scale(i) = 10e3;
v32_high_mgmt_prod_cost.scale(i) = 10e7;
v32_hvarea_forestry.scale(j,kforestry,ac_sub,mgmt_type) = 10e-4;
v32_land_reduction.scale(j,type32,ac) = 10e-3;
...
v39_cost_landcon_annuity.scale(j,land) = 10e3;
v43_watavail.scale(wat_src,j) = 10e5;
vm_bioenergy_utility.scale(i) = 10e4;
vm_carbon_stock.scale(j,land,c_pools) = 10e3;
vm_cost_AEI.scale(i) = 10e5;
vm_cost_fore.scale(i) = 10e7;
vm_cost_glo.scale = 10e8;
vm_cost_landcon.scale(j,land) = 10e4;
vm_cost_natveg.scale(i) = 10e3;
vm_cost_processing.scale(i) = 10e5;
vm_cost_prod.scale(i,kall) = 10e4;
vm_cost_trade.scale(i) = 10e5;
vm_costs_additional_mon.scale(i) = 10e5;
