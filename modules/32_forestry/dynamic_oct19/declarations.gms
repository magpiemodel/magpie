...
parameters
 ...
 p32_rot_length(t,j)                                Cellular rotation length of plantations (yr)
 ...
 p32_management_factor(j)               Management factor used to upscale plantation yields as compared to natural forest yields (1)
