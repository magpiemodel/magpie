...
*****forestry emissions seen in maccs module****************************************
 q32_net_cdr_aff(j2,emis_source_co2_forestry) .. 
 	vm_cdr_aff(j2,emis_source_co2_forestry)
	=e=
	v32_cdr_aff(j2,emis_source_co2_forestry) - v32_bph_warming_aff(j2,emis_source_co2_forestry)*1/0.0021;
                                                                                 
 q32_cdr_aff(j2,emis_source_co2_forestry) .. 
 		v32_cdr_aff(j2,emis_source_co2_forestry) 
		=e=
 ...
 q32_bph_warming_aff(j2) .. v32_bph_warming_aff(j2,"forestry_vegc") =e=
                            -f32_bph_warming_defor(j2)*s32_bph_effect*(sum(si, v32_land(j2,"new",si))/sum((land,si), pcm_land(j2,land,si)));
