...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_hvarea_forestry(t,j,ac,"marginal")         = vm_hvarea_forestry.m(j,ac);
 ...
 ov_hvarea_forestry(t,j,ac,"level")            = vm_hvarea_forestry.l(j,ac);
 ...
 ov_hvarea_forestry(t,j,ac,"upper")            = vm_hvarea_forestry.up(j,ac);
 ...
 ov_hvarea_forestry(t,j,ac,"lower")            = vm_hvarea_forestry.lo(j,ac);
