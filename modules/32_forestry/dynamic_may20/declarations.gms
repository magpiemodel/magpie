...
parameters
 ...
 p32_cdr_ac_plant(t,j,ac)						                      Non-cumulative CDR from afforestation for each age-class depending on planning horizon (tC per ha)
...
equations
 ...
 q32_establishment_max                               Establishment in current time step for future demand (mio. ha)
 q32_establishment_min(i)                               Establishment in current time step for future demand (mio. ha)
...
parameters
 ...
 oq32_establishment_max(t,type)                  Establishment in current time step for future demand (mio. ha)
 oq32_establishment_min(t,i,type)                Establishment in current time step for future demand (mio. ha)
