...
equations
 ...
 q32_establishment_prod(i)                               Establishment in current time step for future demand (mio. ha)
...
parameters
 ...
 oq32_establishment_prod(t,i,type)               Establishment in current time step for future demand (mio. ha)
