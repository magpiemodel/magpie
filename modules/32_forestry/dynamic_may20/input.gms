...
scalars
  ...
  s32_distribution_type           Which type of distribution shall be used for initializing plantations (0=equal distribution 1=FAO distribution 2=Poulter distribution) /3/
