...
parameters
 ...
 p32_aff_togo_glo(t)                                Remaining afforestation area wrt to the maximum exogenous target over time (mio. ha)
 p32_aff_togo_reg(t,i)                              Remaining regional afforestation area wrt to the maximum exogenous target over time (mio. ha)
