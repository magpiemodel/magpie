...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 oq10_croplandreduction(t,j,land,"marginal")  = q10_croplandreduction.m(j,land);
 oq10_croplandreduction2(t,j,land,"marginal") = q10_croplandreduction2.m(j,land);
 oq10_croplandexpansion(t,j,land,"marginal")  = q10_croplandexpansion.m(j,land);
 oq10_croplandexpansion2(t,j,land,"marginal") = q10_croplandexpansion2.m(j,land);
 ...
 oq10_croplandreduction(t,j,land,"level")     = q10_croplandreduction.l(j,land);
 oq10_croplandreduction2(t,j,land,"level")    = q10_croplandreduction2.l(j,land);
 oq10_croplandexpansion(t,j,land,"level")     = q10_croplandexpansion.l(j,land);
 oq10_croplandexpansion2(t,j,land,"level")    = q10_croplandexpansion2.l(j,land);
 ...
 oq10_croplandreduction(t,j,land,"upper")     = q10_croplandreduction.up(j,land);
 oq10_croplandreduction2(t,j,land,"upper")    = q10_croplandreduction2.up(j,land);
 oq10_croplandexpansion(t,j,land,"upper")     = q10_croplandexpansion.up(j,land);
 oq10_croplandexpansion2(t,j,land,"upper")    = q10_croplandexpansion2.up(j,land);
 ...
 oq10_croplandreduction(t,j,land,"lower")     = q10_croplandreduction.lo(j,land);
 oq10_croplandreduction2(t,j,land,"lower")    = q10_croplandreduction2.lo(j,land);
 oq10_croplandexpansion(t,j,land,"lower")     = q10_croplandexpansion.lo(j,land);
 oq10_croplandexpansion2(t,j,land,"lower")    = q10_croplandexpansion2.lo(j,land);
