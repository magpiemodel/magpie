...
$Ifi "%phase%" == "scaling" $include "./modules/51_nitrogen/rescaled_jan21/scaling.gms"
$Ifi "%phase%" == "start" $include "./modules/51_nitrogen/rescaled_jan21/start.gms"
...
$Ifi "%phase%" == "solve" $include "./modules/51_nitrogen/rescaled_jan21/solve.gms"
$Ifi "%phase%" == "intersolve" $include "./modules/51_nitrogen/rescaled_jan21/intersolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/51_nitrogen/rescaled_jan21/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/51_nitrogen/rescaled_jan21/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/51_nitrogen/rescaled_jan21/nl_release.gms"
$Ifi "%phase%" == "nl_relax" $include "./modules/51_nitrogen/rescaled_jan21/nl_relax.gms"
