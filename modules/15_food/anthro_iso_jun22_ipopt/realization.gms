...
$Ifi "%phase%" == "sets" $include "./modules/15_food/anthro_iso_jun22_ipopt/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/15_food/anthro_iso_jun22_ipopt/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/15_food/anthro_iso_jun22_ipopt/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/15_food/anthro_iso_jun22_ipopt/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/15_food/anthro_iso_jun22_ipopt/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/15_food/anthro_iso_jun22_ipopt/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/15_food/anthro_iso_jun22_ipopt/presolve.gms"
$Ifi "%phase%" == "intersolve" $include "./modules/15_food/anthro_iso_jun22_ipopt/intersolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/15_food/anthro_iso_jun22_ipopt/postsolve.gms"
