...
i15_intake_standardized_pc_iso(t,iso)     Intake requirements of a standardized weight population dependent on dempgraphic structure (kcal per captia per day)
;
