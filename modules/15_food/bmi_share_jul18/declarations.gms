...
equations
  ...
  q15_regr_bmi_shr(iso,sex,agegroup15,bmi_regr_type15) estimates regression parameters for BMI regression shares (capita per capita)
...
positive variables
  ...
  v15_regr_overgroups(iso,sex,agegroup15,bmi_regr_type15)   hierarchical tree parameter regressions (capita per capita))
...
* anthropometrics
  ...
  i15_bmi_shr_calib_lastcalibrationyear(iso,sex,age,bmi_group15) calibration parameters of the last year with historical observatiosn (capita per capita)
...
parameters
 ...
 ov15_regr_overgroups(t,iso,sex,agegroup15,bmi_regr_type15,type) hierarchical tree parameter regressions (capita per capita))
 ...
 oq15_regr_bmi_shr(t,iso,sex,agegroup15,bmi_regr_type15,type)    estimates regression parameters for BMI regression shares (capita per capita)
