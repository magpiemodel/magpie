...
* anthropometrics
  ...
  i15_bmi_shr_calib_lastcalibyear(iso,sex,age,bmi_group15) Calibration parameters of the last year with historical observatiosn (1)
...
parameters
 ...
 oq15_regr(t,iso,regr15,type)                                   Estimates parameters for food demand and dietary composition (kcal per kcal)
