...
parameters
 ...
 ov15_regression(t,iso,demand_subsys15,type)     Uncalibrated regression estimates of kcal shares (kcal per kcal)
 ov15_income_pc_real_ppp_iso(t,iso,type)         real income per capita (USD05X per cap)
