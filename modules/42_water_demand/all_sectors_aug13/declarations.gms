...
parameters
 pm42_wat_req_k(t,j,k)               LPJmL annual water demand for irrigation per ha per yr and livestock demand per ton per yr (m^3)
...
positive variables
  ...
  vm_water_cost(j)                   Cost of irrigation water (USD per m^3 per yr)
;
