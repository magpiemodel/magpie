...
parameter f50_nr_fix_ndfa(t_all,i,kcr) Nr fixation rates per ton dry matter plant production (%/tDM)
/
$ondelim
...
parameter f50_nitrogen_balanceflow(t_all,i) Balancelfow to account for unrealistically high SNUpEs on croplands (Tg N/yr)
/
$ondelim
...
parameter f50_nitrogen_balanceflow_pasture(t_all,i) Balancelfow to account for unrealistically high NUE on pastures (Tg N/yr)
/
$ondelim
...
parameter f50_nr_fix_area(kcr) Nr fixation rates per area (t/ha)
/
$ondelim
...
parameter f50_nr_fixation_rates_pasture(t_all,i) Nr fixation rates per pasture area (t/ha)
/
$ondelim
...
parameter f50_atmospheric_deposition_rates(t_all,i,land,dep_scen50) Nr deposition rates per area (t/ha)
/
$ondelim
