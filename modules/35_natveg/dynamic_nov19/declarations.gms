...
parameters
 ...
 p35_yield_natveg(t,j,ac,kforestry)   Yield of natural vegetation (m3 per ha per yr)
 p35_yield_primforest(t,j,kforestry)  Yield of primary vegetation (m3 per ha per yr)
