...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_hvarea_secdforest(t,j,ac_sub,kforestry,"marginal") = vm_hvarea_secdforest.m(j,ac_sub,kforestry);
 ov_hvarea_other(t,j,ac_sub,kforestry,"marginal")      = vm_hvarea_other.m(j,ac_sub,kforestry);
 ov_hvarea_primforest(t,j,kforestry,"marginal")        = vm_hvarea_primforest.m(j,kforestry);
 ov_secdforest_change(t,j,kforestry,ac_sub,"marginal") = vm_secdforest_change.m(j,kforestry,ac_sub);
 ov_primforest_change(t,j,kforestry,"marginal")        = vm_primforest_change.m(j,kforestry);
 ov_other_change(t,j,kforestry,ac_sub,"marginal")      = vm_other_change.m(j,kforestry,ac_sub);
 ...
 oq35_secdf_change_constraint(t,"marginal")            = q35_secdf_change_constraint.m;
 oq35_primf_change_constraint(t,"marginal")            = q35_primf_change_constraint.m;
 oq35_other_change_constraint(t,"marginal")            = q35_other_change_constraint.m;
 ...
 ov_hvarea_secdforest(t,j,ac_sub,kforestry,"level")    = vm_hvarea_secdforest.l(j,ac_sub,kforestry);
 ov_hvarea_other(t,j,ac_sub,kforestry,"level")         = vm_hvarea_other.l(j,ac_sub,kforestry);
 ov_hvarea_primforest(t,j,kforestry,"level")           = vm_hvarea_primforest.l(j,kforestry);
 ov_secdforest_change(t,j,kforestry,ac_sub,"level")    = vm_secdforest_change.l(j,kforestry,ac_sub);
 ov_primforest_change(t,j,kforestry,"level")           = vm_primforest_change.l(j,kforestry);
 ov_other_change(t,j,kforestry,ac_sub,"level")         = vm_other_change.l(j,kforestry,ac_sub);
 ...
 oq35_secdf_change_constraint(t,"level")               = q35_secdf_change_constraint.l;
 oq35_primf_change_constraint(t,"level")               = q35_primf_change_constraint.l;
 oq35_other_change_constraint(t,"level")               = q35_other_change_constraint.l;
 ...
 ov_hvarea_secdforest(t,j,ac_sub,kforestry,"upper")    = vm_hvarea_secdforest.up(j,ac_sub,kforestry);
 ov_hvarea_other(t,j,ac_sub,kforestry,"upper")         = vm_hvarea_other.up(j,ac_sub,kforestry);
 ov_hvarea_primforest(t,j,kforestry,"upper")           = vm_hvarea_primforest.up(j,kforestry);
 ov_secdforest_change(t,j,kforestry,ac_sub,"upper")    = vm_secdforest_change.up(j,kforestry,ac_sub);
 ov_primforest_change(t,j,kforestry,"upper")           = vm_primforest_change.up(j,kforestry);
 ov_other_change(t,j,kforestry,ac_sub,"upper")         = vm_other_change.up(j,kforestry,ac_sub);
 ...
 oq35_secdf_change_constraint(t,"upper")               = q35_secdf_change_constraint.up;
 oq35_primf_change_constraint(t,"upper")               = q35_primf_change_constraint.up;
 oq35_other_change_constraint(t,"upper")               = q35_other_change_constraint.up;
 ...
 ov_hvarea_secdforest(t,j,ac_sub,kforestry,"lower")    = vm_hvarea_secdforest.lo(j,ac_sub,kforestry);
 ov_hvarea_other(t,j,ac_sub,kforestry,"lower")         = vm_hvarea_other.lo(j,ac_sub,kforestry);
 ov_hvarea_primforest(t,j,kforestry,"lower")           = vm_hvarea_primforest.lo(j,kforestry);
 ov_secdforest_change(t,j,kforestry,ac_sub,"lower")    = vm_secdforest_change.lo(j,kforestry,ac_sub);
 ov_primforest_change(t,j,kforestry,"lower")           = vm_primforest_change.lo(j,kforestry);
 ov_other_change(t,j,kforestry,ac_sub,"lower")         = vm_other_change.lo(j,kforestry,ac_sub);
 ...
 oq35_secdf_change_constraint(t,"lower")               = q35_secdf_change_constraint.lo;
 oq35_primf_change_constraint(t,"lower")               = q35_primf_change_constraint.lo;
 oq35_other_change_constraint(t,"lower")               = q35_other_change_constraint.lo;
