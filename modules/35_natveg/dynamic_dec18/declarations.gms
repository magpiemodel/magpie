...
positive variables
  ...
  v35_prod(j2,land_natveg,kforestry)          Timber production coming from natveg (mio. m3)
;
...
parameters
 ...
 ov35_prod(t,j2,land_natveg,kforestry,type)        Timber production coming from natveg (mio. m3)
