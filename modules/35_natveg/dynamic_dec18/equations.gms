...
q35_production_timber..
                          sum((kforestry,i2,cell(i2,j2)),vm_prod(j2,kforestry)) * 0.30
                          =g=
                          sum((kforestry,i2,cell(i2,j2)),sum(land_natveg, v35_prod(j2,land_natveg,kforestry)) + v35_prod_external(j2,kforestry))
                          ;
