...
q35_cost_harvest(i2)..
                    ...
                    sum(ac_sub, v35_hvarea_secdforest(j2,kforestry,ac_sub) * (fm_harvest_cost_ha(i2)*1.2))
                  + sum(ac_sub, v35_hvarea_other(j2,"woodfuel",ac_sub) * fm_harvest_cost_ha(i2) * 0.8)
