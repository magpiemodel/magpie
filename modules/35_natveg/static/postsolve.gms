...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_hvarea_secdforest(t,j,ac,"marginal") = v35_hvarea_secdforest.m(j,ac);
 ov_hvarea_other(t,j,ac,"marginal")      = v35_hvarea_other.m(j,ac);
 ov_hvarea_primforest(t,j,"marginal")    = v35_hvarea_primforest.m(j);
 ...
 ov_hvarea_secdforest(t,j,ac,"level")    = v35_hvarea_secdforest.l(j,ac);
 ov_hvarea_other(t,j,ac,"level")         = v35_hvarea_other.l(j,ac);
 ov_hvarea_primforest(t,j,"level")       = v35_hvarea_primforest.l(j);
 ...
 ov_hvarea_secdforest(t,j,ac,"upper")    = v35_hvarea_secdforest.up(j,ac);
 ov_hvarea_other(t,j,ac,"upper")         = v35_hvarea_other.up(j,ac);
 ov_hvarea_primforest(t,j,"upper")       = v35_hvarea_primforest.up(j);
 ...
 ov_hvarea_secdforest(t,j,ac,"lower")    = v35_hvarea_secdforest.lo(j,ac);
 ov_hvarea_other(t,j,ac,"lower")         = v35_hvarea_other.lo(j,ac);
 ov_hvarea_primforest(t,j,"lower")       = v35_hvarea_primforest.lo(j);
