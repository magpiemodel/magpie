...
parameters
 ...
 p35_min_forest(t,j) 			                        Minimum forest stock [land conservation for climate change mitigation] (Mha)
 p35_min_other(t,j)      		                      Minimum other land stock [land conservation for climate change mitigation] (Mha)
 ...
 p35_consv_dist(j,ac)                             Distribution of secondary forest conservation (1)
