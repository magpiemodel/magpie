...
equations
 ...
 q35_carbon_primforest1(j,ag_pools)            Primforest carbon stock calculation (mio tC)
 q35_carbon_primforest2(j,ag_pools)            Primforest carbon stock calculation (mio tC)
 q35_carbon_primforest3(j,ag_pools)            Primforest carbon stock calculation (mio tC)
 q35_carbon_primforest4(j,ag_pools)            Primforest carbon stock calculation (mio tC)
 q35_carbon_secdforest1(j,ag_pools)            Secdforest carbon stock calculation (mio tC)
 q35_carbon_secdforest2(j,ag_pools)            Secdforest carbon stock calculation (mio tC)
 q35_carbon_secdforest3(j,ag_pools)            Secdforest carbon stock calculation (mio tC)
 q35_carbon_secdforest4(j,ag_pools)            Secdforest carbon stock calculation (mio tC)
 q35_carbon_other1(j,ag_pools)      	       Other land carbon stock calculation (mio tC)
 q35_carbon_other2(j,ag_pools)      	       Other land carbon stock calculation (mio tC)
 q35_carbon_other3(j,ag_pools)      	       Other land carbon stock calculation (mio tC)
 q35_carbon_other4(j,ag_pools)      	       Other land carbon stock calculation (mio tC)
...
parameters
 ...
 oq35_carbon_primforest1(t,j,ag_pools,type)     Primforest carbon stock calculation (mio tC)
 oq35_carbon_primforest2(t,j,ag_pools,type)     Primforest carbon stock calculation (mio tC)
 oq35_carbon_primforest3(t,j,ag_pools,type)     Primforest carbon stock calculation (mio tC)
 oq35_carbon_primforest4(t,j,ag_pools,type)     Primforest carbon stock calculation (mio tC)
 oq35_carbon_secdforest1(t,j,ag_pools,type)     Secdforest carbon stock calculation (mio tC)
 oq35_carbon_secdforest2(t,j,ag_pools,type)     Secdforest carbon stock calculation (mio tC)
 oq35_carbon_secdforest3(t,j,ag_pools,type)     Secdforest carbon stock calculation (mio tC)
 oq35_carbon_secdforest4(t,j,ag_pools,type)     Secdforest carbon stock calculation (mio tC)
 oq35_carbon_other1(t,j,ag_pools,type)          Other land carbon stock calculation (mio tC)
 oq35_carbon_other2(t,j,ag_pools,type)          Other land carbon stock calculation (mio tC)
 oq35_carbon_other3(t,j,ag_pools,type)          Other land carbon stock calculation (mio tC)
 oq35_carbon_other4(t,j,ag_pools,type)          Other land carbon stock calculation (mio tC)
