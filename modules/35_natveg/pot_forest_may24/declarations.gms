...
parameters
 ...
 i35_youngsecdf(t,j,ac)                           Initial secdforest (mio. ha)
 ...
 pc35_youngsecdf(t,j,ac)                           Young secdforest per age class in current time step (mio. ha)
...
positive variables
  ...
  v35_youngsecdf(j,ac)                          Detailed stock of young secdforest (<20 tC/ha) (mio. ha)
