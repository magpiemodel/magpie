...
parameters
 ...
 i35_youngsecdf(j,ac)                             Initial young secdforest (mio. ha)
 i35_other(j,ac)                                  Initial other land (mio. ha)
 p35_secdforest(t,j,ac)                           Secdforest per age class (mio. ha)
 p35_youngsecdf(t,j,ac)                           Young secdforest per age class (mio. ha)
 ...
 pc35_youngsecdf(j,ac)                            Young secdforest per age class in current time step (mio. ha)
 ...
 pm_max_forest_est(j)                             Overall forest establishment potential (mio. ha)
...
positive variables
  ...
  v35_youngsecdf(j,ac)                          Detailed stock of young secdforest (mio. ha)
...
parameters
 ...
 ov35_youngsecdf(t,j,ac,type)                        Detailed stock of young secdforest (mio. ha)
