...
parameters
 ...
 i35_land_other(j,ac,othertype35)                        Initial other land (mio. ha)
 p35_secdforest(t,j,ac)                                  Secdforest per age class (mio. ha)
 p35_land_other(t,j,ac,othertype35)                      Other land per age class (mio. ha)
 pc35_secdforest(j,ac)                                   Secdforest per age class in current time step (mio. ha)
 pc35_land_other(j,ac,othertype35)                       Other land per age class in current time step (mio. ha)
 ...
 p35_max_forest_recovery(j)                              Maximum forest recovery potential after land abandonement (mio. ha)
 p35_carbon_density_other(t,j,ac,othertype35,ag_pools)   Carbon density other land (tC per ha)
...
equations
 ...
 q35_other_reduction(j,ac,othertype35)                   Other land reduction (mio. ha)
 ...
 q35_hvarea_other(j,ac,othertype35)                      Harvested area other land (mio. ha)
...
positive variables
  ...
  vm_land_other(j,ac,othertype35)                        Detailed stock of other land (mio. ha)
  ...
  v35_other_reduction(j,ac,othertype35)                  Other land reduction compared to previous timestep (mio. ha)
  ...
  v35_hvarea_other(j,ac,othertype35)                     Harvested area from other land (mio. ha)
...
parameters
 ...
 ov_land_other(t,j,ac,othertype35,type)              Detailed stock of other land (mio. ha)
 ...
 ov35_other_reduction(t,j,ac,othertype35,type)       Other land reduction compared to previous timestep (mio. ha)
 ...
 ov35_hvarea_other(t,j,ac,othertype35,type)          Harvested area from other land (mio. ha)
 ...
 oq35_other_reduction(t,j,ac,othertype35,type)       Other land reduction (mio. ha)
 ...
 oq35_hvarea_other(t,j,ac,othertype35,type)          Harvested area other land (mio. ha)
