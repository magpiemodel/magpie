...
pm_max_forest_est(j) = f35_pot_forest_area(j) - sum(land_forest, vm_land.l(j,land_forest));
pm_max_forest_est(j)$(pm_max_forest_est(j) < 0) = 0;

*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ov35_secdforest(t,j,ac,"marginal")                        = v35_secdforest.m(j,ac);
 ov35_youngsecdf(t,j,ac,"marginal")                        = v35_youngsecdf.m(j,ac);
 ...
 ov35_youngsecdf(t,j,ac,"level")                           = v35_youngsecdf.l(j,ac);
 ...
 ov35_youngsecdf(t,j,ac,"upper")                           = v35_youngsecdf.up(j,ac);
 ...
 ov35_youngsecdf(t,j,ac,"lower")                           = v35_youngsecdf.lo(j,ac);
