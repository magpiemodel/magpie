...
*' @title Natural Vegetation (natveg)
*'
*' @description The natveg land module is one of the land modules in MAgPIE 
...
$Ifi "%natveg%" == "dynamic_jun18" $include "./modules/35_natveg/dynamic_jun18.gms"
