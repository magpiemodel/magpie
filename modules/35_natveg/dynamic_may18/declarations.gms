...
parameters
 p35_carbon_density_secdforest(t,j,land35,ag_pools) Above ground carbon density secdforest (tC per ha)
 p35_carbon_density_other(t,j,land35,ag_pools) 	    Above ground carbon density other land (tC per ha)
...
equations
 ...
 q35_carbon_primforest(j,ag_pools)   Primforest above ground carbon stock calculation (mio tC)
 q35_carbon_secdforest(j,ag_pools)   Secdforest above ground carbon stock calculation (mio tC)
 q35_carbon_other(j,ag_pools)      	 Other land above ground carbon stock calculation (mio tC)
...
parameters
 ...
 oq35_carbon_secdforest(t,j,ag_pools,type)  Secdforest above ground carbon stock calculation (mio tC)
 oq35_carbon_other(t,j,ag_pools,type)       Other land above ground carbon stock calculation (mio tC)
