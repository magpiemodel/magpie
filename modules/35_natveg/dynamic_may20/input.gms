...
s35_forest_damage Damage simulation in forests (0=none 1=Wildfire 2=Combination of wildfire and shiftingagriculture) /0/
s35_cstock_modifier The carbon stocks be modified in presolve (0=no 1=yes) /1/
;
