...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov_secdforest_reduction(t,j,ac,"marginal")      = vm_secdforest_reduction.m(j,ac);
 ov_primforest_reduction(t,j,"marginal")         = vm_primforest_reduction.m(j);
 ov_other_reduction(t,j,ac,"marginal")           = vm_other_reduction.m(j,ac);
 ...
 oq35_secdforest_change(t,j,ac,"marginal")       = q35_secdforest_change.m(j,ac);
 oq35_primforest_change(t,j,"marginal")          = q35_primforest_change.m(j);
 oq35_other_change(t,j,ac,"marginal")            = q35_other_change.m(j,ac);
 ...
 ov_secdforest_reduction(t,j,ac,"level")         = vm_secdforest_reduction.l(j,ac);
 ov_primforest_reduction(t,j,"level")            = vm_primforest_reduction.l(j);
 ov_other_reduction(t,j,ac,"level")              = vm_other_reduction.l(j,ac);
 ...
 oq35_secdforest_change(t,j,ac,"level")          = q35_secdforest_change.l(j,ac);
 oq35_primforest_change(t,j,"level")             = q35_primforest_change.l(j);
 oq35_other_change(t,j,ac,"level")               = q35_other_change.l(j,ac);
 ...
 ov_secdforest_reduction(t,j,ac,"upper")         = vm_secdforest_reduction.up(j,ac);
 ov_primforest_reduction(t,j,"upper")            = vm_primforest_reduction.up(j);
 ov_other_reduction(t,j,ac,"upper")              = vm_other_reduction.up(j,ac);
 ...
 oq35_secdforest_change(t,j,ac,"upper")          = q35_secdforest_change.up(j,ac);
 oq35_primforest_change(t,j,"upper")             = q35_primforest_change.up(j);
 oq35_other_change(t,j,ac,"upper")               = q35_other_change.up(j,ac);
 ...
 ov_secdforest_reduction(t,j,ac,"lower")         = vm_secdforest_reduction.lo(j,ac);
 ov_primforest_reduction(t,j,"lower")            = vm_primforest_reduction.lo(j);
 ov_other_reduction(t,j,ac,"lower")              = vm_other_reduction.lo(j,ac);
 ...
 oq35_secdforest_change(t,j,ac,"lower")          = q35_secdforest_change.lo(j,ac);
 oq35_primforest_change(t,j,"lower")             = q35_primforest_change.lo(j);
 oq35_other_change(t,j,ac,"lower")               = q35_other_change.lo(j,ac);
