...
rotamax_red30(rotamax30) = yes$(sum(i, i30_rotation_incentives(t,i,rotamax30) > 0) and f30_rotation_rules(rotamax30) < 1);
rotamin_red30(rotamin30) = yes$(sum(i, i30_rotation_incentives(t,i,rotamin30) > 0) and f30_rotation_rules(rotamin30) > 0);
