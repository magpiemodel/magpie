...
positive variables
 ...
 vm_rotation_penalty(i)               Penalty for violating rotational constraints - fixed to zero in this realization (mio. USD17MER)
...
parameters
 ...
 ov_rotation_penalty(t,i,type)               Penalty for violating rotational constraints - fixed to zero in this realization (mio. USD17MER)
