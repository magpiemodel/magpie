...
parameters
 ...
 p57_maccs_costs_integral(t,i,emis_source,pollutants)     costs of technical mitigation (USD per tC)
 i57_mac_step(t,i)                                        helper to map CO2 prices and maccs_steps (1)
;

equations
 q57_total_costs(i)                                     calculation of total costs of technical mitigation (mio.USD)
;
