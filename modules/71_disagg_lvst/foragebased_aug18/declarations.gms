...
equations
 ...
 q71_balanceflow_constraint_nlp(j,kforage) Nonlinear balanceflow constraint for cellular forage feed products (mio. tDM per yr)
 q71_balanceflow_constraint_lp(i,kforage)  Linear balanceflow constraint for cellular forage feed product (mio. tDM per yr)
...
parameters
 ...
 oq71_balanceflow_constraint_nlp(t,j,kforage,type) Nonlinear balanceflow constraint for cellular forage feed products (mio. tDM per yr)
 oq71_balanceflow_constraint_lp(t,i,kforage,type)  Linear balanceflow constraint for cellular forage feed product (mio. tDM per yr)
