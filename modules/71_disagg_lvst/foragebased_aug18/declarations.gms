...
equations
 ...
 q71_feed_balanceflow(j)                           Balanceflow constraint for forage feed products (mio. tDM per yr)
...
parameters
 ...
 oq71_feed_balanceflow(t,j,type)         Balanceflow constraint for forage feed products (mio. tDM per yr)
