...
q71_feed_rum_liv(j2,kforage) ..
                 vm_prod(j2,kforage)
                 =g= sum(kli_rum, v71_prod_rum(j2,kli_rum,kforage)
...
q71_balanceflow_constraint_lp(i2,kli_rum,kforage)$(s71_lp_fix=1) ..
                 ...
                 =e= sum(cell(i2,j2), v71_feed_balanceflow(j2,kli_rum,kforage))
                 ;
...
q71_prod_mon_liv(j2,kli_mon) ..
                 vm_prod(j2,kli_mon)
                 =e= i71_urban_area_share(j2) * sum(cell(i2,j2),vm_prod_reg(i2,kli_mon))
                 ;