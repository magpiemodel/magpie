...
q71_balanceflow_constrain(j2,kli_rum,kforage) ..
				 v71_feed_balanceflow(j2,kli_rum,kforage)
				 =e=
				 sum((ct,cell(i2,j2)), fm_feed_balanceflow(ct,i2,kli_rum,kforage)/ 
				     (im_feed_baskets(ct,i2,kli_rum,kforage) * vm_prod_reg(i2,kli_rum)  +10**(-6)))$(s71_lp_nlp = 0)
               + sum((ct,cell(i2,j2)), fm_feed_balanceflow(ct,i2,kli_rum,kforage)/ 
				     (im_feed_baskets(ct,i2,kli_rum,kforage) * pc71_prod_reg(i2,kli_rum)+10**(-6)))$(s71_lp_nlp = 1)
				;	
