...
$Ifi "%phase%" == "sets" $include "./modules/13_tc/endo_jun18_woa/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/13_tc/endo_jun18_woa/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/13_tc/endo_jun18_woa/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/13_tc/endo_jun18_woa/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/13_tc/endo_jun18_woa/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/13_tc/endo_jun18_woa/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/13_tc/endo_jun18_woa/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/13_tc/endo_jun18_woa/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/13_tc/endo_jun18_woa/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/13_tc/endo_jun18_woa/nl_release.gms"
$Ifi "%phase%" == "nl_relax" $include "./modules/13_tc/endo_jun18_woa/nl_relax.gms"
