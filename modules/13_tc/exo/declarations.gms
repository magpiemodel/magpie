...
positive variable
 ...
 vm_tech_cost(i)             Costs of TC (mio. USD17PPP per yr)
;

parameters
 p13_cost_tc(i,tautype)      Technical change costs per region (mio. USD17PPP)
 ...
 p13_tech_cost(i,tautype)    Annuitized costs of TC for crops and pasture (mio. USD17PPP per yr)
;

*#################### R SECTION START (OUTPUT DECLARATIONS) ####################
parameters
 ov_tau(t,h,tautype,type) Agricultural land use intensity tau (1)
 ov_tech_cost(t,i,type)   Costs of TC (mio. USD17PPP per yr)
;
