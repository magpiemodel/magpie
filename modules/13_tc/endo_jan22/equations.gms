...
*' heuristically derived power function of the land use intensity `v13_tau` for
...
q13_cost_tc(i2, tautype) ..
  v13_cost_tc(i2, tautype) =e= sum(ct, pc13_land(i2, tautype) *
                     i13_tc_factor(ct) * sum(supreg(h2,i2),v13_tau(h2,tautype))**
...
q13_tech_cost(i2, tautype) ..
 v13_tech_cost(i2, tautype) =e= sum(supreg(h2,i2), v13_tau(h2,tautype)/pc13_tau(h2,tautype)-1) * v13_cost_tc(i2,tautype)
