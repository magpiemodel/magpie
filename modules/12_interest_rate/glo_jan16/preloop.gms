...
$elseif "%c12_interest_rate%" == "mixed"
 p12_interest(t_all,i) = sum(t_to_i_to_dev("y1995",i,dev), sum(scen12_to_dev(scen12,dev), f12_interest(t_all,scen12)))
 ;
$else
 p12_interest(t_all,i) =  f12_interest(t_all,"%c12_interest_rate%")
 ;
$endif
