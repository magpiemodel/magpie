...
$elseif "%c12_interest_rate%" == "mixed"
 p12_interest(t,i) = sum(t_to_i_to_dev("y1995",i,dev), sum(scen12_to_dev(scen12,dev), f12_interest(t,scen12))) * p12_interestscen_region_shr(t,i)
                      + f12_interest(t,"medium") * (1-p12_interestscen_region_shr(t,i))
 ;
$else
 p12_interest(t,i) =  f12_interest(t,"%c12_interest_rate%") * p12_interestscen_region_shr(t,i)
                      + f12_interest(t,"medium") * (1-p12_interestscen_region_shr(t,i))
 ;
$endif
