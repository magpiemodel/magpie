...
t_to_i_to_dev(t,i,"lic") = yes$(im_gdp_pc(t,i) <= 1045);
t_to_i_to_dev(t,i,"mic") = yes$(im_gdp_pc(t,i) > 1045 AND im_gdp_pc(t,i) < 12746);
t_to_i_to_dev(t,i,"hic") = yes$(im_gdp_pc(t,i) >= 12746);
