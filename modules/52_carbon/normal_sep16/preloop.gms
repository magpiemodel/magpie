...
pm_carbon_density_ac(t,j,ac,"vegc") = m_growth_vegc(fm_carbon_density(t,j,"other","vegc"),sum(clcl,pm_climate_class(t,j,clcl)*f52_growth_par(clcl,"k")),sum(clcl,pm_climate_class(t,j,clcl)*f52_growth_par(clcl,"m")),(ord(ac)-1));
