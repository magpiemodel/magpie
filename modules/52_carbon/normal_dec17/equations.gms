...
*' the previous time step.
 ...
 q52_carbon_stock_change(j2,land,c_pools) ..
                 vm_carbon_stock_change(j2,land,c_pools) =e=
                 pcm_carbon_stock(j2,land,c_pools) - vm_carbon_stock(j2,land,c_pools);

*' Annual CO2 emissions are obtained by dividing `vm_carbon_stock_change` by
*' time step length (e.g. 5 or 10 years).
 ...
 q52_co2c_emis(j2,emis_co2) ..
                 ...
                 vm_carbon_stock_change(j2,land,c_pools)/m_timestep_length);
