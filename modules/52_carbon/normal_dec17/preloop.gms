...
pm_carbon_density_ac(t,j,ac,"vegc") = m_growth_vegc(pc52_carbon_density_start(t,j,"vegc"),fm_carbon_density(t,j,"other","vegc"),sum(clcl,pm_climate_class(j,clcl)*fm_growth_par(clcl,"k")),sum(clcl,pm_climate_class(j,clcl)*fm_growth_par(clcl,"m")),(ord(ac)-1));
