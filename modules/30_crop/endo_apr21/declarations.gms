...
equations
 ...
 q30_carbon1(j,ag_pools)         Cropland above ground carbon content calculation (mio. tC)
 q30_carbon2(j,ag_pools)         Cropland above ground carbon content calculation (mio. tC)
 q30_carbon3(j,ag_pools)         Cropland above ground carbon content calculation (mio. tC)
 q30_carbon4(j,ag_pools)         Cropland above ground carbon content calculation (mio. tC)
...
parameters
 ...
 oq30_carbon1(t,j,ag_pools,type)     Cropland above ground carbon content calculation (mio. tC)
 oq30_carbon2(t,j,ag_pools,type)     Cropland above ground carbon content calculation (mio. tC)
 oq30_carbon3(t,j,ag_pools,type)     Cropland above ground carbon content calculation (mio. tC)
 oq30_carbon4(t,j,ag_pools,type)     Cropland above ground carbon content calculation (mio. tC)
