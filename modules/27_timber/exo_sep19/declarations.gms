...
equations
 ...
 q27_prod_timber_forced                   Global forcing from natveg production constraint (mio. m3 per yr)
...
parameters
 ...
 oq27_prod_timber_forced(t,type)                    Global forcing from natveg production constraint (mio. m3 per yr)
;
