...
parameters
 ...
 i35_land(j,ac,si)          inital other land [mio. ha]
 p35_land(t,j,ac,si,when)   other land per age class before and after optimization (mio. ha)
 pc35_land(j,land35,si)     current other land per land35 land type (mio. ha)
...
equations
 ...
 q35_land(j,si)             land pool calculation
...
parameters
 ...
 oq35_land(t,j,si,type)        land pool calculation
