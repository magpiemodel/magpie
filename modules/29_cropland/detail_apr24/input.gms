...
scalars
 ...
 s29_fallow_short_penalty        Penalty for also skipping short fallow (USD17MER per ha) / 300 /
 s29_fallow_long_penalty_target  Target penalty value for skipping long fallow  (USD17MER per ha) / 150 /
 s29_fallow_short_penalty_target Target penalty value for also skipping short fallow (USD17MER per ha) / 300 /
