...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov29_treecover_penalty(t,j,"marginal")         = v29_treecover_penalty.m(j);
 ...
 ov29_fallow_penalty(t,j,"marginal")            = v29_fallow_penalty.m(j);
 ...
 oq29_fallow_shr(t,j,"marginal")                = q29_fallow_shr.m(j);
 oq29_fallow_penalty(t,j,"marginal")            = q29_fallow_penalty.m(j);
 oq29_fallow_missing(t,j,"marginal")            = q29_fallow_missing.m(j);
 oq29_fallow_bv(t,j,potnatveg,"marginal")       = q29_fallow_bv.m(j,potnatveg);
 oq29_treecover_shr(t,j,"marginal")             = q29_treecover_shr.m(j);
 oq29_treecover_penalty(t,j,"marginal")         = q29_treecover_penalty.m(j);
 oq29_treecover_missing(t,j,"marginal")         = q29_treecover_missing.m(j);
 ...
 ov29_treecover_penalty(t,j,"level")            = v29_treecover_penalty.l(j);
 ...
 ov29_fallow_penalty(t,j,"level")               = v29_fallow_penalty.l(j);
 ...
 oq29_fallow_shr(t,j,"level")                   = q29_fallow_shr.l(j);
 oq29_fallow_penalty(t,j,"level")               = q29_fallow_penalty.l(j);
 oq29_fallow_missing(t,j,"level")               = q29_fallow_missing.l(j);
 oq29_fallow_bv(t,j,potnatveg,"level")          = q29_fallow_bv.l(j,potnatveg);
 oq29_treecover_shr(t,j,"level")                = q29_treecover_shr.l(j);
 oq29_treecover_penalty(t,j,"level")            = q29_treecover_penalty.l(j);
 oq29_treecover_missing(t,j,"level")            = q29_treecover_missing.l(j);
 ...
 ov29_treecover_penalty(t,j,"upper")            = v29_treecover_penalty.up(j);
 ...
 ov29_fallow_penalty(t,j,"upper")               = v29_fallow_penalty.up(j);
 ...
 oq29_fallow_shr(t,j,"upper")                   = q29_fallow_shr.up(j);
 oq29_fallow_penalty(t,j,"upper")               = q29_fallow_penalty.up(j);
 oq29_fallow_missing(t,j,"upper")               = q29_fallow_missing.up(j);
 oq29_fallow_bv(t,j,potnatveg,"upper")          = q29_fallow_bv.up(j,potnatveg);
 oq29_treecover_shr(t,j,"upper")                = q29_treecover_shr.up(j);
 oq29_treecover_penalty(t,j,"upper")            = q29_treecover_penalty.up(j);
 oq29_treecover_missing(t,j,"upper")            = q29_treecover_missing.up(j);
 ...
 ov29_treecover_penalty(t,j,"lower")            = v29_treecover_penalty.lo(j);
 ...
 ov29_fallow_penalty(t,j,"lower")               = v29_fallow_penalty.lo(j);
 ...
 oq29_fallow_shr(t,j,"lower")                   = q29_fallow_shr.lo(j);
 oq29_fallow_penalty(t,j,"lower")               = q29_fallow_penalty.lo(j);
 oq29_fallow_missing(t,j,"lower")               = q29_fallow_missing.lo(j);
 oq29_fallow_bv(t,j,potnatveg,"lower")          = q29_fallow_bv.lo(j,potnatveg);
 oq29_treecover_shr(t,j,"lower")                = q29_treecover_shr.lo(j);
 oq29_treecover_penalty(t,j,"lower")            = q29_treecover_penalty.lo(j);
 oq29_treecover_missing(t,j,"lower")            = q29_treecover_missing.lo(j);
