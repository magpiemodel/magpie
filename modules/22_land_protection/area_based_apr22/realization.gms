...
*' reports.Area-based protection as derived from WDPA is based on observed land protection
*' trends. In 1995, the total area under land protection (across all land types) in the
...
*' 2020 land protection is held constant at 2020 values. The protected area based on WDPA
*' includes all areas under legal protectionmeeting the IUCN and CBD protected area definitions
