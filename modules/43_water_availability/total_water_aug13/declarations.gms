...
parameters
 ...
 p43_exo_wat_req("y1995",j)         Water demand at the time of initialization (mio. m^3 per yr)
 i43_crop_area("y1995",j,w,kcr)    Input parameter to capture crop area at the time of initialization (mio. ha)
;
