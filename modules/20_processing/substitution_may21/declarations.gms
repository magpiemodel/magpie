...
parameters
 ...
 i20_processing_unitcosts(ksd,kpr)          Costs of transforming x units kpr into 1 unit ksd (USD17MER per tDM)
 ;
...
positive variables
  ...
  vm_cost_processing(i)                          Processing costs (mio. USD17MER per yr)
;

variables
  vm_processing_substitution_cost(i)             Costs or benefits of substituting one product by another (mio. USD17MER per yr)
;
...
equations
     ...
     q20_processing_costs(i)                            Processing costs (mio. USD17MER per yr)
...
parameters
 ...
 ov_cost_processing(t,i,type)                             Processing costs (mio. USD17MER per yr)
 ov_processing_substitution_cost(t,i,type)                Costs or benefits of substituting one product by another (mio. USD17MER per yr)
 ...
 oq20_processing_costs(t,i,type)                          Processing costs (mio. USD17MER per yr)
