...
$ondelim
$include "./modules/20_processing/sector_may15/input/f20_processing_balanceflow.cs3"
$offdelim
...
$ondelim
$include "./modules/20_processing/sector_may15/input/f20_processing_conversion_factors.cs3"
$offdelim       ;

table f20_processing_shares(t_all,i,ksd,kpr)   shares of secondary products coming from a primary product (1)
$ondelim
$include "./modules/20_processing/sector_may15/input/f20_processing_shares.cs3"
$offdelim       ;
