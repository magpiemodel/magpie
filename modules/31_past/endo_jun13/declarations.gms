...
equations
 ...
 q31_cost_prod_past(i)    Costs for putting animals on pastures (mio. USD17MER per yr)
...
positive variables
 vm_cost_prod_past(i)                  Costs for putting animals on pastures (mio. USD17MER per yr)
;
*#################### R SECTION START (OUTPUT DECLARATIONS) ####################
parameters
 ov_cost_prod_past(t,i,type)              Costs for putting animals on pastures (mio. USD17MER per yr)
 ...
 oq31_cost_prod_past(t,i,type)            Costs for putting animals on pastures (mio. USD17MER per yr)
