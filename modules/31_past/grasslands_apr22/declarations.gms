...
positive variables
v31_cost_grass_expansion(j, grassland)                  Costs for grassland transitions (mio. USD05MER)
;

*#################### R SECTION START (OUTPUT DECLARATIONS) ####################
parameters
 ov31_grass_area(t,j,grassland,type)           Grass production area (mio. ha)
 ov31_cost_grass_expansion(t,j,grassland,type) Costs for grassland transitions (mio. USD05MER)
