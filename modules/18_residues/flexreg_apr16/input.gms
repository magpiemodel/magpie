...
table f18_multicropping_reg(t_all,i,kcr) Multicropping indicator as ratio of area harvested by physical area (1)
$ondelim
$include "./modules/18_residues/input/fm_multicropping_iso.cs3"
$offdelim;
