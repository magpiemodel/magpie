...
$Ifi "%phase%" == "sets" $include "./modules/18_residues/flexclusterall_jan24/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/18_residues/flexclusterall_jan24/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/18_residues/flexclusterall_jan24/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/18_residues/flexclusterall_jan24/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/18_residues/flexclusterall_jan24/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/18_residues/flexclusterall_jan24/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/18_residues/flexclusterall_jan24/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/18_residues/flexclusterall_jan24/postsolve.gms"
