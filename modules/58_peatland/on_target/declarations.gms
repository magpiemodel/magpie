...
* q58_peatland_intact(j,stat_degrad58)			Intact to degrad peatland constraint (mio. ha)
 q58_peatland_rewet(j,land58)					Intact to degrad peatland constraint (mio. ha)
...
parameters
 ...
 oq58_peatland_rewet(t,j,land58,type)       Intact to degrad peatland constraint (mio. ha)
