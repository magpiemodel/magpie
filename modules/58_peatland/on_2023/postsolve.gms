...
if (m_year(t) = s58_fix_peatland,
  p58_scaling_factor(j)$(sum(land, vm_land.l(j,land)) > 1e-20) = sum(land58, f58_peatlandArea(j,land58)) / sum(land, vm_land.l(j,land));
  pc58_peatland(j,"crop") = min(f58_peatlandArea(j,"crop"),vm_land.l(j,"crop") * p58_scaling_factor(j));
  pc58_peatland(j,"past") = min(f58_peatlandArea(j,"past"), vm_land.l(j,"past") * p58_scaling_factor(j));
  pc58_peatland(j,"forestry") = min(f58_peatlandArea(j,"forestry"), vm_land.l(j,"forestry") * p58_scaling_factor(j));
