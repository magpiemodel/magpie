...
parameters
 ...
 p58_ipcc_wetland_ef(clcl58,land58,emis58) Wetland GWP100 emission factors (t CO2eq per ha)
 p58_man_land_area(j)               Total managed land (mio. ha)
 pc58_peatland(j,land58)          Managed peatland (mio. ha)
...
equations
 ...
 q58_peatland_crop(j)          Constraint for peatland degradation (mio. ha)
 q58_peatland_past(j)          Constraint for peatland degradation (mio. ha)
 q58_peatland_forestry(j)          Constraint for peatland degradation (mio. ha)
 ...
 q58_peatland_emis_detail(j,land58,emis58)       Detailed GHG emissions from managed peatland (t CO2eq per year)
...
variables
 ...
 v58_peatland_emis(j,land58,emis58)        Detailed GHG emissions from managed peatland (t CO2eq per year)
;
...
parameters
 ...
 ov58_peatland_emis(t,j,land58,emis58,type)        Detailed GHG emissions from managed peatland (t CO2eq per year)
 ...
 oq58_peatland_crop(t,j,type)                      Constraint for peatland degradation (mio. ha)
 oq58_peatland_past(t,j,type)                      Constraint for peatland degradation (mio. ha)
 oq58_peatland_forestry(t,j,type)                  Constraint for peatland degradation (mio. ha)
 ...
 oq58_peatland_emis_detail(t,j,land58,emis58,type) Detailed GHG emissions from managed peatland (t CO2eq per year)
