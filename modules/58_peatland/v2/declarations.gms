...
equations
 ...
 q58_peatland_cost_annuity_intact_decrease(j)   Annuity costs for reduction of intact peatland in the current timestep (mio. USD05MER per yr)
 q58_peatland_cost_annuity_rewet_decrease(j)    Annuity costs for reduction of rewetted peatland in the current timestep (mio. USD05MER per yr)
 q58_peatland_cost_annuity_rewet_increase(j)    Annuity costs for expansion of rewetted peatland in the current timestep (mio. USD05MER per yr)
...
positive variables
 ...
 v58_peatland_cost_annuity_intact_decrease(j) Annuity costs for reduction of intact peatland in the current timestep (mio. USD05MER per yr)
 v58_peatland_cost_annuity_rewet_decrease(j)  Annuity costs for reduction of rewetted peatland in the current timestep (mio. USD05MER per yr)
 v58_peatland_cost_annuity_rewet_increase(j)  Annuity costs for expansion of rewetted peatland in the current timestep (mio. USD05MER per yr)
;
...
parameters
 ...
 ov58_peatland_cost_annuity_intact_decrease(t,j,type) Annuity costs for reduction of intact peatland in the current timestep (mio. USD05MER per yr)
 ov58_peatland_cost_annuity_rewet_decrease(t,j,type)  Annuity costs for reduction of rewetted peatland in the current timestep (mio. USD05MER per yr)
 ov58_peatland_cost_annuity_rewet_increase(t,j,type)  Annuity costs for expansion of rewetted peatland in the current timestep (mio. USD05MER per yr)
 ...
 oq58_peatland_cost_annuity_intact_decrease(t,j,type) Annuity costs for reduction of intact peatland in the current timestep (mio. USD05MER per yr)
 oq58_peatland_cost_annuity_rewet_decrease(t,j,type)  Annuity costs for reduction of rewetted peatland in the current timestep (mio. USD05MER per yr)
 oq58_peatland_cost_annuity_rewet_increase(t,j,type)  Annuity costs for expansion of rewetted peatland in the current timestep (mio. USD05MER per yr)
