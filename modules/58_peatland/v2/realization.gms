...
*' and the [Global Peatland Database](https://greifswaldmoor.de/global-peatland-database-en.html), both for the year 2020. 
...
*' Rewetted peatland area can only increase if degraded peatland area declines and intact peatland area remains constant.
*' @stop
