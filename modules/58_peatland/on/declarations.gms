...
positive variables
 ...
 v58_balance_positive(j,from58,to58)		Balance variable for peatland transitions (mio. ha)
 v58_balance_negative(j,from58,to58)		Balance variable for peatland transitions (mio. ha)
;
...
parameters
 ...
 ov58_balance_positive(t,j,from58,to58,type) Balance variable for peatland transitions (mio. ha)
 ov58_balance_negative(t,j,from58,to58,type) Balance variable for peatland transitions (mio. ha)
