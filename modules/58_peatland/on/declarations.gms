...
parameters
 ...
 p58_ipcc_wetland_ef(clcl_simple,land58,emis58,man58) Wetland GWP100 emission factors (t CO2eq per ha)
 ...
 p58_mapping_cell_climate(j,clcl_simple)				Mapping between cells and climate regions (binary)
