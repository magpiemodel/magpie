...
if (m_year(t) = s58_fix_peatland,
	...
	p58_calib_factor(j,land58)$(v58_land.l(j,land58) * p58_scaling_factor(j) > 0) = (p58_peatland_degrad(j) * p58_peatland_degrad_weight(j,land58)) / (v58_land.l(j,land58)*p58_scaling_factor(j));
