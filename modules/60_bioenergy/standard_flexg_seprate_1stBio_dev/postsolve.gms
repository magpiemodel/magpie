...
*#################### R SECTION START (OUTPUT DEFINITIONS) #####################
 ...
 ov60_convexhull(t,i,kcr,"marginal")           = v60_convexhull.m(i,kcr);
 oq60_bioenergy_glo(t,"marginal")              = q60_bioenergy_glo.m;
 oq60_bioenergy_reg(t,i,"marginal")            = q60_bioenergy_reg.m(i);
 oq60_1st_bioenergy(t,i,"marginal")            = q60_1st_bioenergy.m(i);
 oq60_1st_bioenergy_convexhull(t,i,"marginal") = q60_1st_bioenergy_convexhull.m(i);
 ov_cost_bioen(t,i,"level")                    = vm_cost_bioen.l(i);
 ov_dem_bioen(t,i,kall,"level")                = vm_dem_bioen.l(i,kall);
 ov60_convexhull(t,i,kcr,"level")              = v60_convexhull.l(i,kcr);
 oq60_bioenergy_glo(t,"level")                 = q60_bioenergy_glo.l;
 oq60_bioenergy_reg(t,i,"level")               = q60_bioenergy_reg.l(i);
 oq60_1st_bioenergy(t,i,"level")               = q60_1st_bioenergy.l(i);
 oq60_1st_bioenergy_convexhull(t,i,"level")    = q60_1st_bioenergy_convexhull.l(i);
 ov_cost_bioen(t,i,"upper")                    = vm_cost_bioen.up(i);
 ov_dem_bioen(t,i,kall,"upper")                = vm_dem_bioen.up(i,kall);
 ov60_convexhull(t,i,kcr,"upper")              = v60_convexhull.up(i,kcr);
 oq60_bioenergy_glo(t,"upper")                 = q60_bioenergy_glo.up;
 oq60_bioenergy_reg(t,i,"upper")               = q60_bioenergy_reg.up(i);
 oq60_1st_bioenergy(t,i,"upper")               = q60_1st_bioenergy.up(i);
 oq60_1st_bioenergy_convexhull(t,i,"upper")    = q60_1st_bioenergy_convexhull.up(i);
 ov_cost_bioen(t,i,"lower")                    = vm_cost_bioen.lo(i);
 ov_dem_bioen(t,i,kall,"lower")                = vm_dem_bioen.lo(i,kall);
 ov60_convexhull(t,i,kcr,"lower")              = v60_convexhull.lo(i,kcr);
 oq60_bioenergy_glo(t,"lower")                 = q60_bioenergy_glo.lo;
 oq60_bioenergy_reg(t,i,"lower")               = q60_bioenergy_reg.lo(i);
 oq60_1st_bioenergy(t,i,"lower")               = q60_1st_bioenergy.lo(i);
 oq60_1st_bioenergy_convexhull(t,i,"lower")    = q60_1st_bioenergy_convexhull.lo(i);
