...
scalars 
 ...
 s44_start_price		Price for biodiversity stock loss in start year (USD per ha) 	/ 2000 /
 s44_target_price		Price for biodiversity stock loss in target year (USD per ha) 	/ 5000 /
;
