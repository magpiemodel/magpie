...
scalars
  s40_pasture_transport_costs  Transport costs for pasture (USD17MER per tDM per min)     / 0 /
;
...
parameter f40_transport_costs(kall) Relative transport costs (USD17MER per tDM per min)
/
$ondelim
