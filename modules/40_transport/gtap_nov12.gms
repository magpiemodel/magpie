...
*' over time. Furthermore, transportation costs for 
*' non-ruminant products are excluded because currently 
*' there is no proper spatial allocation process for 
*' these products implemented.
