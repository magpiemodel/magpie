...
The model documentation for version 4.6.0 can be found at
https://rse.pik-potsdam.de/doc/magpie/4.6.0/
...
## CITATION
See file CITATION.cff or the [How-to-Cite section](https://rse.pik-potsdam.de/doc/magpie/4.6.0/#how-to-cite) in the model documentation for information how to cite the model.
